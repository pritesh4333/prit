...
class _IPVScreenLargeState extends State<IPVScreenLarge> {
              ...
              Expanded(
                child: Container(
                  ...
                  child: Text(
                    ...
                    style: TextStyle(color: Color(0xFF000000), fontFamily: 'century_gothic', fontSize: 16, fontWeight: FontWeight.w400),
                  ),
                ),
              ),
            ],
              ...
              Expanded(
                child: Container(
                  ...
                  child: Text(
                    ...
                    style: TextStyle(color: Color(0xFF0066CC), fontFamily: 'century_gothic', fontSize: 16, fontWeight: FontWeight.w500),
                  ),
                ),
              ),
            ],
  ...
  static Future<void> saveIPVVideo(BuildContext context, Uint8List bytes) async {
    IpvScreenBlock ipcBloc = new IpvScreenBlock();
    var getuserdetailsobj = await ipcBloc.saveIPVDocument(context, "large", bytes, "");
  ...
  getMedia() {
    html.window.navigator.mediaDevices?.getUserMedia({"video": true, "audio": true}).then(
      (streamHandle) {
        ...
        // _webcamVideoElement.addTextTrack("Hiasdasda");
        // _webcamVideoElement.appendHtml("textasdadasdasd");
        _webcamVideoElement.appendText("adasdasdas");
        // _webcamVideoElement.createFragment("adhkjasdkjd");
        // _webcamVideoElement.insertAdjacentText("asd", "asdasd");
