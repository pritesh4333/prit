...
class ReIPVReportWebScreen extends StatefulWidget {
  final String title;
  const ReIPVReportWebScreen({
    Key? key,
    required this.title,
  }) : super(key: key);

  @override
  State<ReIPVReportWebScreen> createState() => _ReIPVReportWebScreenState();
}

class _ReIPVReportWebScreenState extends State<ReIPVReportWebScreen> {
                            ...
                            children: [
                              InkWell(
                                ...
                                onTap: () async {
                                  ...
                                  document.dispose();
                                  await helper.FileSaveHelper.saveAndLaunchFile(bytes, 'ReipvReport.xlsx');
                              ...
                              InkWell(
                                ...
                                onTap: () async {
                                  ...
                                  document.dispose();
                                  await helper.FileSaveHelper.saveAndLaunchFile(bytes, 'ReipvReport.pdf');
                                },
