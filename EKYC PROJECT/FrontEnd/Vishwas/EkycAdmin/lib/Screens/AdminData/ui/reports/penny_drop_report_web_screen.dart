...
class PennyDropReportWebScreen extends StatefulWidget {
  final String title;
  const PennyDropReportWebScreen({
    Key? key,
    required this.title,
  }) : super(key: key);

  @override
  State<PennyDropReportWebScreen> createState() => _PennyDropReportWebScreenState();
}

class _PennyDropReportWebScreenState extends State<PennyDropReportWebScreen> {
                            ...
                            children: [
                              InkWell(
                                ...
                                onTap: () async {
                                  ...
                                  document.dispose();
                                  await helper.FileSaveHelper.saveAndLaunchFile(bytes, 'PennyDropReport.xlsx');
                              ...
                              InkWell(
                                ...
                                onTap: () async {
                                  ...
                                  document.dispose();
                                  await helper.FileSaveHelper.saveAndLaunchFile(bytes, 'PennyDropReport.pdf');
                                },
