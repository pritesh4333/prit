...
class RejectionReportWebScreen extends StatefulWidget {
  final String title;
  const RejectionReportWebScreen({
    Key? key,
    required this.title,
  }) : super(key: key);

  @override
  State<RejectionReportWebScreen> createState() => _RejectionReportWebScreenState();
}

class _RejectionReportWebScreenState extends State<RejectionReportWebScreen> {
                            ...
                            children: [
                              InkWell(
                                ...
                                onTap: () async {
                                  ...
                                  document.dispose();
                                  await helper.FileSaveHelper.saveAndLaunchFile(bytes, 'RejectionReport.xlsx');
                              ...
                              InkWell(
                                ...
                                onTap: () async {
                                  ...
                                  document.dispose();
                                  await helper.FileSaveHelper.saveAndLaunchFile(bytes, 'RejectionReport.pdf');
                                },
