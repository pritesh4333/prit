...
class PaymentReportWebScreen extends StatefulWidget {
  final String title;
  const PaymentReportWebScreen({
    Key? key,
    required this.title,
  }) : super(key: key);

  @override
  State<PaymentReportWebScreen> createState() => _PaymentReportWebScreenState();
}

class _PaymentReportWebScreenState extends State<PaymentReportWebScreen> {
                            ...
                            children: [
                              InkWell(
                                ...
                                onTap: () async {
                                  ...
                                  document.dispose();
                                  await helper.FileSaveHelper.saveAndLaunchFile(bytes, 'PaymentReport.xlsx');
                              ...
                              InkWell(
                                ...
                                onTap: () async {
                                  ...
                                  document.dispose();
                                  await helper.FileSaveHelper.saveAndLaunchFile(bytes, 'PaymentReport.pdf');
                                },
