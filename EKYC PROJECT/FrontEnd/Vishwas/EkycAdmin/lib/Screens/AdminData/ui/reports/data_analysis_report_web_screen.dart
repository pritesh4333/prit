...
class DataAnalysisReportWebScreen extends StatefulWidget {
  final String title;
  const DataAnalysisReportWebScreen({
    Key? key,
    required this.title,
  }) : super(key: key);

  @override
  State<DataAnalysisReportWebScreen> createState() => _DataAnalysisReportWebScreenState();
}

class _DataAnalysisReportWebScreenState extends State<DataAnalysisReportWebScreen> {
                            ...
                            children: [
                              InkWell(
                                ...
                                onTap: () async {
                                  ...
                                  document.dispose();
                                  await helper.FileSaveHelper.saveAndLaunchFile(bytes, 'DataAnalysisReport.xlsx');
                              ...
                              InkWell(
                                ...
                                onTap: () async {
                                  ...
                                  document.dispose();
                                  await helper.FileSaveHelper.saveAndLaunchFile(bytes, 'DataAnalysisReport.pdf');
                                },
      ...
      child: FutureBuilder<List<DashBoardResponseModel>?>(
        ...
        builder: (context, snapshot) {
          if ((snapshot.data != null) && (snapshot.hasData)) {
            ...
            columnList.add('Completed Users');
            ...
            for (final element in (snapshot.data ?? [])) {
              ...
              if (element.reporttitle == "all") {
                allCount = element.count?.toString() ?? "0";
              }
            }
            ...
            data['Completed Users'] = completedusercount;
            data['Finish'] = finishusercount;
            data['Total'] = allCount;
            data['Mismatch'] = "0";
            dataList.add(data);
