...
class StatusReportWebScreen extends StatefulWidget {
  final String title;
  const StatusReportWebScreen({
    Key? key,
    required this.title,
  }) : super(key: key);

  @override
  State<StatusReportWebScreen> createState() => _StatusReportWebScreenState();
}

class _StatusReportWebScreenState extends State<StatusReportWebScreen> {
                            ...
                            children: [
                              InkWell(
                                ...
                                onTap: () async {
                                  ...
                                  document.dispose();
                                  await helper.FileSaveHelper.saveAndLaunchFile(bytes, 'StatusReport.xlsx');
                              ...
                              InkWell(
                                ...
                                onTap: () async {
                                  ...
                                  document.dispose();
                                  await helper.FileSaveHelper.saveAndLaunchFile(bytes, 'StatusReport.pdf');
                                },
