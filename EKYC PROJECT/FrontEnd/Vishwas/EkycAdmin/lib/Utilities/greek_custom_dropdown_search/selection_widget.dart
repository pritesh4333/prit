...
import 'package:ekyc_admin/Utilities/greek_custom_dropdown_search/checkbox_widget.dart';
import 'package:ekyc_admin/Utilities/greek_custom_dropdown_search/greek_dropdown_search.dart';
      ...
      child: ValueListenableBuilder(
          ...
          builder: (ctx, value, wdgt) {
            return Column(
              ...
              children: <Widget>[
                AppConfig().currentPlatform == AppPlatform.web
                    ? _searchField()
                    : Container(),
    ...
    if ((widget.itemBuilder != null)) {
      ...
      return ListTile(
        ...
        title: Text(
          ...
          style: _isSelectedItem(item)
              ? GreekTextStyle.dropDownSelectedTextStyle
              : GreekTextStyle.dropDownUnselectedItemTextStyle,
        ),
      );
    }
  }
        ...
        children: <Widget>[
          ...
          if (widget.showSearchBox)
            Container(
              ...
              child: TextField(
                style: GreekTextStyle.dropDownSelectedItemTextStyle,
