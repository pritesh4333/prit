...
import 'package:ekyc_admin/Utilities/greek_custom_dropdown_search/popup_menu.dart';
import 'package:ekyc_admin/Utilities/greek_custom_dropdown_search/popup_safearea_props.dart';
import 'package:ekyc_admin/Utilities/greek_custom_dropdown_search/scrollbar_props.dart';
import 'package:ekyc_admin/Utilities/greek_custom_dropdown_search/selection_widget.dart';
import 'package:ekyc_admin/Utilities/greek_custom_dropdown_search/selection_list_view_props.dart';
import 'package:ekyc_admin/Utilities/greek_custom_dropdown_search/text_field_props.dart';
...
class GreekDropdownSearch<T> extends StatefulWidget {
  ...
  GreekDropdownSearch.multiSelection({
    Key? key,
    this.autoValidateMode = AutovalidateMode.disabled,
    this.mode = Mode.dialog,
    this.labelText,
  ...
  @override
  GreekDropdownSearchState<T> createState() => GreekDropdownSearchState<T>();
}

class GreekDropdownSearchState<T> extends State<GreekDropdownSearch<T>> {
  ...
  @override
  void didUpdateWidget(GreekDropdownSearch<T> oldWidget) {
    ...
    Widget defaultItemMultiSelectionMode(T item) {
      return Container(
        ...
        child: Text(
          ...
          style: GreekTextStyle.dropDownDefaultSelectedItemTextStyle,
        ),
      );
    }
    ...
    Widget selectedItemWidget() {
      ...
      return Text(
        ...
        style: widget.selectedTextStyle ??
            GreekTextStyle.dropDownSelectedItemTextStyle,
      );
    }
  ...
  InputDecoration _manageDropdownDecoration(FormFieldState state) {
    return (widget.dropdownSearchDecoration ??
        ...
        .copyWith(
            enabled: widget.enabled,
            labelText:
                widget.labelText ?? widget.dropdownSearchDecoration?.labelText,
            hintText:
                widget.hintText ?? widget.dropdownSearchDecoration?.hintText,
 ...
 ///open BottomSheet (Dialog mode)
  ...
  Future _openMenu() {
    ...
    return customShowMenu<T>(
        ...
        items: [
          CustomPopupMenuItem(
            textStyle: GreekTextStyle.dropDownDefaultSelectedItemTextStyle,
            child: SizedBox(
  ...
  Future _selectSearchMode() async {
    _handleFocus(true);
    if (widget.mode == Mode.popup_menu) {
      await _openMenu();
