...
package com.acumengroup.greekmain.util.encryption;
...
/* ********  E N C O D I N G   M E T H O D S  ******** */
    ...
    public static void encode(java.nio.ByteBuffer raw, java.nio.ByteBuffer encoded) {
        ...
        while (raw.hasRemaining()) {
            ...
            raw.get(raw3, 0, rem);
            Base64Decoder.encode3to4(enc4, raw3, rem, Base64Decoder.NO_OPTIONS);
            encoded.put(enc4);
        }   // end input remaining
    }
     ...
     * @return The Base64-encoded object
     * @see Base64Decoder#GZIP
     * @see Base64Decoder#DO_BREAK_LINES
     * @throws java.io.IOException if there is an error
     * @since 2.0
     */
    ...
    public static byte[] encodeBytesToBytes(byte[] source) {
        byte[] encoded = null;
        try {
            encoded = encodeBytesToBytes(source, 0, source.length, Base64Decoder.NO_OPTIONS);
        } catch (java.io.IOException ex) {
...
/* ********  D E C O D I N G   M E T H O D S  ******** */
    ...
    public static byte[] decode(byte[] source) throws java.io.IOException {
        byte[] decoded = null;
//        try {
        decoded = decode(source, 0, source.length, Base64Decoder.NO_OPTIONS);
//        } catch( java.io.IOException ex ) {
//            assert false : "IOExceptions only come from GZipping, which is turned off: " + ex.getMessage();
//        }
        return decoded;
    ...
    public static void encodeToFile(byte[] dataToEncode, String filename) throws java.io.IOException {
        ...
        try {
            bos = new OutputStream(new java.io.FileOutputStream(filename), Base64Decoder.ENCODE);
    ...
    public static void decodeToFile(String dataToDecode, String filename) throws java.io.IOException {
        ...
        OutputStream bos = null;
        try {
            bos = new OutputStream(new java.io.FileOutputStream(filename), Base64Decoder.DECODE);
    ...
    public static byte[] decodeFromFile(String filename) throws java.io.IOException {
        ...
        try {
            ...
            // Open a stream
            bis = new InputStream(new java.io.BufferedInputStream(new java.io.FileInputStream(file)), Base64Decoder.DECODE);
    ...
    public static String encodeFromFile(String filename) throws java.io.IOException {
        ...
        try {
            ...
            // Open a stream
            bis = new InputStream(new java.io.BufferedInputStream(new java.io.FileInputStream(file)), Base64Decoder.ENCODE);
            ...
            // Save in a variable to return
            encodedData = new String(buffer, 0, length, Base64Decoder.PREFERRED_ENCODING);
    ...
    public static void encodeFileToFile(String infile, String outfile) throws java.io.IOException {
        ...
        String encoded = Base64Decoder.encodeFromFile(infile);
    ...
    public static void decodeFileToFile(String infile, String outfile) throws java.io.IOException {
        ...
        byte[] decoded = Base64Decoder.decodeFromFile(infile);
        java.io.OutputStream out = null;
        try {
            out = new java.io.BufferedOutputStream(new java.io.FileOutputStream(outfile));
            out.write(decoded);
    ...
    public static class InputStream extends java.io.FilterInputStream {
         ...
         * @param in the <tt>java.io.InputStream</tt> from which to read data.
         * @param options Specified options
         * @see Base64Decoder#ENCODE
         * @see Base64Decoder#DECODE
         * @see Base64Decoder#DO_BREAK_LINES
         * @since 2.0
         */
            ...
            // Else, Decoding
                ...
                if (decodabet[theByte & 0x7f] > WHITE_SPACE_ENC) {
                    ...
                    if (position >= bufferLength) { // Enough to output.
                        ...
                        int len = Base64Decoder.decode4to3(buffer, 0, b4, 0, options);
                        out.write(b4, 0, len);
                        position = 0;
                    }   // end if: enough to output
