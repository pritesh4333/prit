...
public class MutualFundXSIPNewOrderRequest implements GreekRequestModel, GreekResponseModel {
    ...
    public static void sendRequest(MutualFundXSIPNewOrderRequest request, Context ctx, ServiceResponseListener listener) {
        try {
