...
public class CancelOrderRequest implements GreekRequestModel, GreekResponseModel {
    ...
    public static void sendRequest(CancelOrderRequest request, Context ctx, ServiceResponseListener listener) {
        try {
