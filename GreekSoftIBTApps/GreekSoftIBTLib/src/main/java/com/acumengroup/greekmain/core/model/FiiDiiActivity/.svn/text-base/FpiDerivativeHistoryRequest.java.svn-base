...
public class FpiDerivativeHistoryRequest implements GreekRequestModel, GreekResponseModel {

    private String startDate;
    private String endDate;

    public static final String SERVICE_GROUP = "Login";
    public static final String SERVICE_NAME = "getFIIDII_Derivative_History";
    ...
    public static void sendRequest(String startDate,String endDate, Context ctx, ServiceResponseListener listener) {
        FpiDerivativeHistoryRequest request = new FpiDerivativeHistoryRequest();
        try {
