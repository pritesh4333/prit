 ...
 */
public class SendLoginAnswerValidateRequest implements GreekRequestModel, GreekResponseModel {
    ...
    public static final String SERVICE_NAME = "jvalidate_question";
    ...
    public static void sendRequest(SendLoginAnswerValidateRequest request, Context ctx, ServiceResponseListener listener) {
        try {
    ...
    public static void sendRequest(JSONObject request, Context ctx, ServiceResponseListener listener) {
        ...
        jsonRequest.setResponseClass(SendLoginAnswerValidateResponse.class);
        jsonRequest.setService("Login", "jvalidate_question");
    ...
    public static void sendRequest(String gscid, String sessionId, String deviceType, List questionAnswerList, Context ctx, ServiceResponseListener listener) {
        SendLoginAnswerValidateRequest request = new SendLoginAnswerValidateRequest();
