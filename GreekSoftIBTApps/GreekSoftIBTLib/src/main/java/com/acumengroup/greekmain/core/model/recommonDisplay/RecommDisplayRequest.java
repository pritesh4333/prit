...
public class RecommDisplayRequest implements GreekRequestModel, GreekResponseModel {


    private static JSONObject echoParam = null;

    public static final String SERVICE_GROUP = "getRecommData";
    public static final String SERVICE_NAME = "getRecommendations";
