package com.acumengroup.greekmain.core.model.cancelWSP;
...
public class SWPCancelRequest implements GreekRequestModel, GreekResponseModel {
    ...
    public void setSWPRegNo(String SWPRegNo) {
        this.SWPRegNo = SWPRegNo;
    }
    ...
    public GreekResponseModel fromJSON(JSONObject jo) throws JSONException {
        ...
        this.SWPRegNo = jo.optString("SWPRegNo");
    ...
    public static void sendRequest(SWPCancelRequest request, Context ctx, ServiceResponseListener listener) {
        try {
    ...
    public static void sendRequest(String amtUnit, String regno, String flag, String clientcode, String remarks, Context ctx, ServiceResponseListener listener) {
        SWPCancelRequest request = new SWPCancelRequest();
        request.setSWPRegNo(regno);
