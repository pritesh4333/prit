package com.acumengroup.chartiq.sdk;
...
public class ChartIQ extends WebView {
    public String chartiqSdkVersion = "3.1.0";
    public String applicationVersion = "3.1.0";
...
//don't Remove this is for Decimal point
	public void setYAxisDecimalPlace(String decimalpoint) {
		executeJavascript("JSON.stringify(CIQ.ChartEngine.YAxis.prototype.decimalPlaces="+decimalpoint+");", toastCallback);
	}
