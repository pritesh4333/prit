...
public class GainerData implements Parcelable {
    private String name;
    ...
    protected GainerData(Parcel in) {
        name = in.readString();
...
//        perchange=in.readString();
    ...
    public static final Creator<GainerData> CREATOR = new Creator<GainerData>() {
        @Override
        public GainerData createFromParcel(Parcel in) {
            return new GainerData(in);
        }

        @Override
        public GainerData[] newArray(int size) {
            return new GainerData[size];
        }
    };
    ...
    public GainerData(String name, String description, String exchange, String lotSize,
                      String ltp, String ltp1, String ltp2, String change, String perchange,
                      String assettype, String token, String token1, String token2, String volume,
                      String tickSize, String multipliyer, String expiry, String optType,
                      String strikeprice, String instrumentname) {
        this.name = name;
        this.description = description;
        this.exchange=exchange;
        this.lotSize = lotSize;
