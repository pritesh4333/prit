                ...
                if (responseScanData.size > 0) {
                    ...
                    if (responseScanData.size > 0) {
                        if (dMaxLossList != null && dMaxLossList.size > 0) {
                            LossMaxValue = dMaxLossList.maxBy { it }!!.toFloat()
                            LossMinValue = dMaxLossList.minBy { it }!!.toFloat()
                        }
                        if (dMaxGainList != null && dMaxGainList.size > 0) {
                            ProfitMaxValue = dMaxGainList.maxBy { it }!!.toFloat()
                            ProfitMInValue = dMaxGainList.minBy { it }!!.toFloat()
                        }
                    }
