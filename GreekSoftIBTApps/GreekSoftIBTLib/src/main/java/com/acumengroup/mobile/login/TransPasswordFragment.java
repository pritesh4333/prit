...
import static com.acumengroup.mobile.login.PasswordChangeFragment.Comingfrom;


public class TransPasswordFragment extends GreekBaseFragment implements View.OnClickListener, GreekUIServiceHandler, GreekConstants {


    private View transPassView;
    ...
    static String passType = "Transaction Password";
    String reqPassType = "";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        // transPassView = inflater.inflate(R.layout.fragment_trans_password, container, false);

        transPassView = super.onCreateView(inflater, container, savedInstanceState);

        if (AccountDetails.getThemeFlag(getActivity()).equalsIgnoreCase("white")) {

            attachLayout(R.layout.fragment_trans_password).setBackgroundColor(getResources().getColor(R.color.backgroundColorWhite));
        } else {
            attachLayout(R.layout.fragment_trans_password).setBackground(getResources().getDrawable(R.drawable.bg_drawable));
        }
...
//            confirmPwdTxt.setTextColor(getResources().getColor(AccountDetails.textColorDropdown));
//            userIdTxt.setTextColor(getResources().getColor(AccountDetails.textColorDropdown));
//            updateBtn.setTextColor(getResources().getColor(AccountDetails.textColorDropdown));
...
//        }
    ...
    private void setupViews() {
        ...
        userIdTxt = transPassView.findViewById(R.id.usrId_text);

        ti_clientCode = transPassView.findViewById(R.id.ti_clientCode);
        ti_oldPass = transPassView.findViewById(R.id.ti_oldPass);
        ti_newPass = transPassView.findViewById(R.id.ti_newPass);
        ti_confirmPass = transPassView.findViewById(R.id.ti_confirmPass);
        ...
        // userIdTxt.setEnabled(false);
        oldPwdTxt = transPassView.findViewById(R.id.oldPwd_text);
        newPwdTxt = transPassView.findViewById(R.id.newPwd_text);
        confirmPwdTxt = transPassView.findViewById(R.id.confirmPwd_text);
        updateBtn = transPassView.findViewById(R.id.updateBtn);
        ...
        if (AccountDetails.getThemeFlag(getActivity()).equalsIgnoreCase("white")) {
            ...
            oldPwdTxt.setHintTextColor(getResources().getColor(R.color.white));
    ...
    public void onClick(View v) {
        if (updateBtn.equals(v)) {
            if (validateFields()) {
                ...
                ChangePasswordRequest.sendRequest(oldPwdTxt.getText().toString(), newPwdTxt.getText().toString(), userIdTxt.getText().toString(),
                        passtype, AccountDetails.getBrokerId(getActivity()), "", getActivity(), serviceResponseHandler);
        ...
        try {
            ...
            if (ChangePasswordRequest.SERVICE_GROUP.equals(jsonResponse.getServiceGroup())
                ...
                if (changePasswordResponse.getErrorCode().equals("21")) {
                    ...
                    ChangePasswordRequest.sendRequest(oldPwdTxt.getText().toString(), newPwdTxt.getText().toString(), userIdTxt.getText().toString(),
                            passtype, AccountDetails.getBrokerId(getActivity()), BaseURL, getActivity(), serviceResponseHandler);
                    ...
                    GreekDialog.alertDialog(getActivity(), 0, alert_title, getString(R.string.GREEK_CHANGE_PASSWORD_SUCCESS_TXT), "OK", false, new GreekDialog.DialogListener() {
                        ...
                        public void alertDialogAction(GreekDialog.Action action, Object... data) {
                            ...
                            if (Comingfrom != null && Comingfrom.equalsIgnoreCase("PlaceOrder")) {
