...
public class OIAnalysisAdapter extends RecyclerView.Adapter<OIAnalysisAdapter.MyViewHolder> {
    List<GainerData_v2> gainerData;
    AppCompatActivity activity;
    private ArrayList tokenArrayList = new ArrayList();

    public OIAnalysisAdapter(List<GainerData_v2> gainerData, AppCompatActivity activity) {
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        if (gainerData1Item.getAssetType().equalsIgnoreCase("currency")) {
            ...
            holder.changeTxt.setText(StringStuff.commaINRDecorator(String.format("%.4f", Double.parseDouble(gainerData1Item.getChange()))) +
                    "(" + String.format("%.4f", Double.parseDouble(gainerData1Item.getPerchange())) + "%)");
