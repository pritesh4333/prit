...
public class CurrencyTopGainerAdapter extends RecyclerView.Adapter<CurrencyTopGainerAdapter.MyViewHolder> {
    ArrayList<GainerData> gainerData;
    AppCompatActivity activity;
    private ArrayList tokenList = new ArrayList();

    public CurrencyTopGainerAdapter(ArrayList<GainerData> gainerData, AppCompatActivity activity) {
    ...
    @Override
    public void onBindViewHolder(CurrencyTopGainerAdapter.MyViewHolder holder, int position) {
...
//            }
            ...
            if (gainerData1Item.getLtp() != null && !gainerData1Item.getLtp().equalsIgnoreCase("")) {
                ...
                if (gainerData1Item.getAssetType().equalsIgnoreCase("currency")) {
                    holder.ltpTxt.setText(StringStuff.commaINRDecorator(String.format("%.4f", Double.parseDouble(gainerData1Item.getLtp()))));
            ...
            if (gainerData1Item.getChange() != null && !gainerData1Item.getChange().equalsIgnoreCase("") && !gainerData1Item.getPerchange().equalsIgnoreCase("")) {
                ...
                if (gainerData1Item.getAssetType().equalsIgnoreCase("currency")) {
                    ...
                    holder.changeTxt.setText(StringStuff.commaINRDecorator(String.format("%.4f",
                            Double.parseDouble(gainerData1Item.getChange()))) +
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View view) {
            ...
            if(AccountDetails.getThemeFlag(activity).equalsIgnoreCase("White")) {
                ...
                nodataTxt.setTextColor(activity.getColor(R.color.black));
