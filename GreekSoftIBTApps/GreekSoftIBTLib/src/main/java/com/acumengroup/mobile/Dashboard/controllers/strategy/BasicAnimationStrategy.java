package com.acumengroup.mobile.Dashboard.controllers.strategy;
...
import com.acumengroup.mobile.Dashboard.HeightAnimation;
...
public class BasicAnimationStrategy extends AbstractAnimationStrategy {
    ...
    public BasicAnimationStrategy(int displayHeight, View animableView) {
