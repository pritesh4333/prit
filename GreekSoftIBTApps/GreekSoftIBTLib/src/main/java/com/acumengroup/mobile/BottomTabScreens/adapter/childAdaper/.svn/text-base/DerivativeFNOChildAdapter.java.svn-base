...
public class DerivativeFNOChildAdapter extends RecyclerView.Adapter<DerivativeFNOChildAdapter.MyViewHolder> {
    ...
    public DerivativeFNOChildAdapter(ArrayList<GainerData> gainerData, Context activity, String groupPosition, String header, int chlidindex) {
    ...
    public void updateData(int position, GainerData gainerDatalist) {
        Log.d("FNO Length==>>>","pos:- "+position+ " token size "+tokenList.size());
