...
public class QuickActionButtonView extends CustomPopupWindow implements OnClickListener, DialogInterface {
    ...
    private QuickActionButtonAdapter mAdapter;

    public QuickActionButtonView(View anchor, QuickActionButtonAdapter adapter) {
        super(anchor);
    ...
    public QuickActionButtonView setOnClickListener(OnClickListener listener) {
