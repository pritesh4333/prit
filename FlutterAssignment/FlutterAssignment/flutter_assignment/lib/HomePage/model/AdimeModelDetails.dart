...
class AnimDetailsModel {
  Data? data;

  AnimDetailsModel({this.data});

  AnimDetailsModel.fromJson(Map<String, dynamic> json) {
...
class Data {
  ...
  Data({this.malId, this.url, this.images, this.trailer, this.title, this.titleEnglish, this.titleJapanese, this.titleSynonyms, this.type, this.source, this.episodes, this.status, this.airing, this.aired, this.duration, this.rating, this.score, this.scoredBy, this.rank, this.popularity, this.members, this.favorites, this.synopsis, this.background, this.season, this.year, this.broadcast, this.producers});

  Data.fromJson(Map<String, dynamic> json) {
    malId = json['mal_id'];
    url = json['url'];
    images = json['images'] != null ? new Images1.fromJson(json['images']) : null;
    trailer = json['trailer'] != null ? new Trailer.fromJson(json['trailer']) : null;
    title = json['title'];
    ...
    season = json['season'];
    year = json['year'];
    broadcast = json['broadcast'] != null ? new Broadcast.fromJson(json['broadcast']) : null;
