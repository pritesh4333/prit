...
public class MainActivity extends AppCompatActivity {
    ...
    private void GetImage() {
        ...
        try {
            ...
            pDialog.show();
            String url = "https://priteshparmarnew1.000webhostapp.com/sendimageandrecive/Image.txt";
            Log.e("url", "" + url);
...
// Adding request to request queue
    ...
    private void sendImagetoServer() {
        try {
            ...
            String url = "https://priteshparmarnew1.000webhostapp.com/sendimageandrecive/sendimage.php";
            Log.e("url", "" + image);
...
// ...Irrelevant code for customizing the buttons and title
    ...
    private void sendMessageToserver(JSONObject json) {
        ...
        try {
            ...
            String url = "https://priteshparmarnew1.000webhostapp.com/TextFiles/writeMsg.php";
            Log.e("url", "" + url);
...
// Adding request to request queue
    ...
    private void getMessageFromServer() {
        ...
        try {
            ...
            pDialog.setMessage("Loading...");
            pDialog.show();
            String url = "https://priteshparmarnew1.000webhostapp.com/ReadMsg.php";
            Log.e("url", "" + url);
