...
import com.prit.videocompressorpro.View.Activity_galleryview;


import java.util.ArrayList;


public class Adapter_VideoFolder extends ArrayAdapter<Model_Video> {
    ...
    public Adapter_VideoFolder(Context context, ArrayList<Model_Video> al_menu) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            viewHolder = (Adapter_VideoFolder.ViewHolder) convertView.getTag();
        }
