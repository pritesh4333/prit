...
public class UrlSelectionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button Cliqtrade_non_secure = (Button) findViewById(R.id.Cliqtrade_non_secure);
        ...
        Cliqtrade_non_secure.setOnClickListener(view -> {
            setUrl("https://clicktrade.pentagonbroking.com");
        });
    ...
    private void setUrl(String url) {
        ...
        if(url.equalsIgnoreCase("http://trade.vishwasonline.com:3000")){
