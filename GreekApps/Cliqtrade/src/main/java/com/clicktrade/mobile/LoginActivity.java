...
import static com.clicktrade.mobile.SplashActivity.APPNAME;
...
public class LoginActivity extends AppCompatActivity implements GreekUIServiceHandler, GreekConstants, View.OnClickListener {
    ...
    private RelativeLayout customProgress, parentLayout;
...
//    private GreekEditText reset_mpin_edit_one, reset_mpin_edit_two, reset_mpin_edit_three, reset_mpin_edit_four, reset_mpin_edit_five, reset_mpin_edit_six;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cliqtrade_login_screen);
...
//                    String transpass = Util.getPrefs(this).getString("GREEK_RETAINED_CUST_TRANS_PASS", "");
            ...
            if (fromActivity != null) {
                if (fromActivity.equalsIgnoreCase("heartBeat")) {
                    ...
                    GreekDialog.alertDialog(this, 0, APPNAME, "Invalid Session.Heart Beat stopped", "Ok", false, new GreekDialog.DialogListener() {
        ...
        boolean showTrasaction = Util.getPrefs(LoginActivity.this).getBoolean("is_validateTransactionshow", false);
...
//MPIN CREATE EXITTEXT LINSTNER END
    ...
    public void onClick(View view) {
        ...
        String disclaimer = disclaimerstring.replaceAll("APPNAME", "Cliqtrade");
...
//                startActivity(i);
                ...
                intent.putExtra("amt", "");
                startActivity(intent);
            } else if (appname.equalsIgnoreCase("select")) {
                Intent i = new Intent(this, OpenAccountVerification.class);
                i.putExtra("from", "openAcct");
                startActivity(i);
            }
...
//                signUpAsGuest(view);
    ...
    private void proceedToLogin() {
        ...
        if (toProceed) {
            ...
            GreekDialog.alertDialog(this, 0, APPNAME, messageToShow, "OK", true, null);
        }
    }
...
//                    }
            ...
            try {
                ...
                if (loginResponse.getErrorCode().equalsIgnoreCase("0")) {
                    ...
                    GreekDialog.alertDialog(this, 0, APPNAME, getString(R.string.CP_USER_PASSWORD_INVALID_MSG),
                    ...
                    GreekDialog.alertDialog(this, 0, APPNAME, getString(R.string.CP_FAILURE_MSG),
                            "Ok", false, new GreekDialog.DialogListener() {
                    ...
                    GreekDialog.alertDialog(this, 0, APPNAME, getString(R.string.CP_DUPLICATE_MSG), "Ok", false, new GreekDialog.DialogListener() {
                    ...
                    GreekDialog.alertDialog(this, 0, APPNAME, getString(R.string.LP_MAX_ATTEMPTS_MSG), "Ok", false, new GreekDialog.DialogListener() {
                    ...
                    GreekDialog.alertDialog(this, 0, APPNAME, getString(R.string.CP_USER_SUSPENDED), "Ok", false, new GreekDialog.DialogListener() {
                    ...
                    GreekDialog.alertDialog(this, 0, APPNAME, "Same Login and Transaction Password", "Ok", false, new GreekDialog.DialogListener() {
                    ...
                    GreekDialog.alertDialog(this, 0, APPNAME, "Retailer does not exist", "Ok", false, new GreekDialog.DialogListener() {
                    ...
                    GreekDialog.alertDialog(this, 0, APPNAME, "Version Mismatch.Please Update your Application", "Ok", false, new GreekDialog.DialogListener() {
                    ...
                    GreekDialog.alertDialog(this, 0, APPNAME, "Account Locked.Please Contact Admin and Change Password", "Ok", false, new GreekDialog.DialogListener() {
                ...
                if (PassTypeCode.equalsIgnoreCase("0")) {
                    ...
                    if (loginResponse.getExecutionCode() != null && loginResponse.getExecutionCode().equals("0")) {
                        ...
                        if (errorCode.equals("21")) {
                            ...
                            GreekDialog.alertDialog(this, 0, APPNAME, getString(R.string.CP_PASSWORD_EXPIRED_MSG), "Ok", false, new GreekDialog.DialogListener() {
                            ...
                            GreekDialog.alertDialog(this, 0, APPNAME, getString(R.string.CP_BOTH_PASSWORD_EXPIRED_MSG), "Ok", false, new GreekDialog.DialogListener() {
                        ...
                        GreekDialog.alertDialog(this, 0, APPNAME, getString(R.string.CP_LOGIN_ERROR_MSG), "Ok", false, new GreekDialog.DialogListener() {
...
//unused code
            ...
            try {
                ...
                if (errorCode.equals("1")) {
                    GreekDialog.alertDialog(this, 0, APPNAME, "Your password is expired. Please change the password to continue", "Ok", false, new GreekDialog.DialogListener() {
                    ...
                    GreekDialog.alertDialog(this, 0, APPNAME, "Invalid user or password", "Ok", false, new GreekDialog.DialogListener() {
                    ...
                    GreekDialog.alertDialog(this, 0, APPNAME, "Failure", "Ok", false, new GreekDialog.DialogListener() {
                    ...
                    GreekDialog.alertDialog(this, 0, APPNAME, "Duplicate Login", "Ok", false, new GreekDialog.DialogListener() {
                    ...
                    GreekDialog.alertDialog(this, 0, APPNAME, "Version Mismatch.Please Update your Apk", "Ok", false, new GreekDialog.DialogListener() {
...
//                    }
            ...
            try {
                ...
                if (errorCode.equals("0")) {
                    GreekDialog.alertDialog(this, 0, APPNAME, getString(R.string.LP_FORGOT_ANSWER), "Ok", false, new GreekDialog.DialogListener() {
...
//                    }
            ...
            try {
                ...
                if (loginResponse.getClientCode().equalsIgnoreCase("null")) {
                    GreekDialog.alertDialog(this, 0, APPNAME, "Please Enter Valid OTP",
                            "Ok", false, new GreekDialog.DialogListener() {
...
//new end
    ...
    public void handleError(int errorCode, String message, Object error, ServiceRequest serviceRequest) {
        progressLayout.setVisibility(View.GONE);
        GreekDialog.alertDialog(this, 0, APPNAME, message, "OK", true, null);
        btnLogin.setEnabled(true);
    }
