...
public class UrlSelectionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button vishwas_non_secure = (Button) findViewById(R.id.vishwas_non_secure);
        ...
        vishwas_non_secure.setOnClickListener(view -> {
            setUrl("http://trade.vishwasonline.com:3000");
        });
