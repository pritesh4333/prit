...
import static com.vishwas.mobile.SplashActivity.APPNAME;
...
//    private GreekEditText reset_mpin_edit_one, reset_mpin_edit_two, reset_mpin_edit_three, reset_mpin_edit_four, reset_mpin_edit_five, reset_mpin_edit_six;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.vishwas_login);
...
//            if (clientCode == 3) {
//                String VxmlURL = "https://tester.greeksoft.in:3006/index.html";
...
//            }
            ...
            signUpAsGuest(view);
//                GreekDialog.alertDialogOnly(LoginActivity.this, GREEK, getString(R.string.SEBI_STRING));
//                signUpAsGuest(view);
...
// When status updates are no longer needed, unregister the listener.
    ...
    private void popupSnackbarForCompleteUpdate() {
        ...
        snackbar.setActionTextColor(
                getResources().getColor(com.acumengroup.mobile.R.color.white));
        snackbar.show();
    }
