package com.acumengroup.greekmain.core.model.cancelOrder;
...
public class CancelPurchaseOrderRequest implements GreekRequestModel, GreekResponseModel {
    ...
    public static void sendRequest(CancelPurchaseOrderRequest request, Context ctx, ServiceResponseListener listener)
    {
        try
        {
    ...
    @Deprecated
    public static void sendRequest(String transactionCode,String DPTxn,String qty,String allRedeem,String folioNo,String amcName, String amtUnit, String clientCode, String orderType, String purchaseType, String schemeCode, String schemeName, String strToken,String Isin, String regNo,String UniqueRefNo, Context ctx, ServiceResponseListener listener)
    {
        ...
        request.setUniqueRefNo(UniqueRefNo);
