 ...
 */
public class SendGCMInformationRequest implements GreekRequestModel, GreekResponseModel {
    private String gcid;
    ...
    public static void sendRequest(SendGCMInformationRequest request, Context ctx, ServiceResponseListener listener) {
        try {
    ...
    public static void sendRequest(JSONObject request, Context ctx, ServiceResponseListener listener) {
        ...
        jsonRequest.setResponseClass(ReceiveGCMInformationResponse.class);
    ...
    public static void sendRequest(String gcid, String gscid, String sessionId, String deviceId, String gcmApiKey, String gcmDeviceToken, String statusFlag, Context ctx, ServiceResponseListener listener) {
        SendGCMInformationRequest request = new SendGCMInformationRequest();
