...
public class MarketsSingleScripRequest
    ...
    private String pledgeidentifier;
    private String entityidentifier;
    private String returnurl;
    private String pledgorboid;
    private String exid;
    ...
    public String getPledgeidentifier() {
        return pledgeidentifier;
    }

    public void setPledgeidentifier(String pledgeidentifier) {
        this.pledgeidentifier = pledgeidentifier;
    }
    ...
    public String getPledgorboid() {
        return pledgorboid;
    }

    public void setPledgorboid(String pledgorboid) {
        this.pledgorboid = pledgorboid;
    }
    ...
    public JSONObject toJSONObject()
        ...
        jo.put("pledgeidentifier", this.pledgeidentifier);
        jo.put("entityidentifier", this.entityidentifier);
        jo.put("returnurl", this.returnurl);
        jo.put("pledgorboid", this.pledgorboid);
        jo.put("exid", this.exid);
    ...
    public GreekResponseModel fromJSON(JSONObject jo)
        ...
        this.BOId = jo.optString("BOId");
        this.reqType = jo.optString("reqType");
        this.channel = jo.optString("channel");
        this.Segment = jo.optString("Segment");
        this.pledgeidentifier = jo.optString("pledgeidentifier");
        this.entityidentifier = jo.optString("entityidentifier");
        this.returnurl = jo.optString("returnurl");
        this.pledgorboid = jo.optString("pledgorboid");
        this.exid = jo.optString("exid");
    ...
    public static void sendRequestNSDL(JSONObject request, Context ctx, ServiceResponseListener listener) {
        GreekJSONRequest jsonRequest = null;
        jsonRequest = new GreekJSONRequest(ctx, request);
        if (echoParam != null) {
            jsonRequest.setEchoParam(echoParam);
        ...
        jsonRequest.setResponseClass(MarketsSingleScripResponse.class);
        jsonRequest.setService("Markets", "sendAuthorizationRequest_NSDL");
        ServiceManager.getInstance(ctx).sendRequest(jsonRequest, listener);
    }
    ...
    public static void sendRequesNSDL(String gscid, String dPType, String reqType, String requestIdentifier, String ru, String boid, String exID
            , String deviceId,String channel,String  ExID,String Segment, JSONArray jsonArray, AppCompatActivity mainActivity, ServiceResponseHandler serviceResponseHandler) {
        ...
        request.setStockDetails(jsonArray);


        try {
            sendRequestNSDL(request.toJSONObject(), mainActivity, serviceResponseHandler);
    ...
    @Deprecated
    public static void sendRequestPledgeNewFlow(String dpType,String gscid, String deviceId, String reqType,String boid,
                                         JSONArray jsonObject, Context ctx, ServiceResponseListener listener) {
        MarketsSingleScripRequest request = new MarketsSingleScripRequest();
        request.setGscid(gscid);
        request.setDPType(dpType);
        request.setPledgeidentifier("MP");
        request.setEntityidentifier("TM");
        request.setReturnurl(WSHandler.LIVE_URL+"/getPledgeCDSLResponseMobile");
        request.setPledgorboid(boid);
        request.setExid("11");
        request.setDeviceId(deviceId);

        request.setStockDetails(jsonObject);
        try {
            sendEPledgeRequestNewFlow(request.toJSONObject(), ctx, listener);
    ...
    private static void sendEPledgeRequestNewFlow(JSONObject toJSONObject, Context ctx, ServiceResponseListener listener) {
        GreekJSONRequest jsonRequest = null;
        ...
        jsonRequest.setResponseClass(MarketsSingleScripResponse.class);
        jsonRequest.setService("Markets", "Pledge_CDSL");
        ServiceManager.getInstance(ctx).sendRequest(jsonRequest, listener);
    }
    ...
    @Deprecated
    public static void sendRequestPledgeNSDL(String ru,String requestIdentifier,String dPType,String channel,String Segment,String ExID,String gscid, String deviceId, String reqType,String boid,
                                         JSONArray jsonObject, Context ctx, ServiceResponseListener listener) {
        MarketsSingleScripRequest request = new MarketsSingleScripRequest();
        request.setGscid(gscid);
        request.setDPType(dPType);
        ...
        request.setRU(ru);
        request.setBOID(boid);
        request.setExID(gscid);
        request.setDeviceId(deviceId);
        request.setChannel(channel);
         request.setSegment(Segment);
        request.setStockDetails(jsonObject);
        try {
            sendEPledgeRequestNSDL(request.toJSONObject(), ctx, listener);
    ...
    private static void sendEPledgeRequestNSDL(JSONObject toJSONObject, Context ctx, ServiceResponseListener listener) {
        GreekJSONRequest jsonRequest = null;
        jsonRequest = new GreekJSONRequest(ctx, toJSONObject);
        if (echoParam != null) {
            jsonRequest.setEchoParam(echoParam);
        ...
        Log.e("nsdlepledgerequest",toJSONObject.toString());
        jsonRequest.setResponseClass(MarketsSingleScripResponse.class);
        jsonRequest.setService("Markets", "pledge_NSDL");
        ServiceManager.getInstance(ctx).sendRequest(jsonRequest, listener);
    }
    @Deprecated
