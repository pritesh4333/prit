...
import static com.acumengroup.greekmain.core.constants.ServiceConstants.KYC_SVC_NAME;
import static com.acumengroup.greekmain.core.constants.ServiceConstants.UPLOAD_PHOTO_SVC_GROUP;

public class MFundMediaUploadRequest implements GreekRequestModel, GreekResponseModel {
    ...
    public static void sendRequest(String imgeId, String clientCode, String imgeString, String imgType, String panNumber,
        ...
        MFundMediaUploadRequest request = new MFundMediaUploadRequest();
    ...
    @Deprecated
    public static void sendRequestKYC(String clientCode, String panNumber, String flag, Context ctx, ServiceResponseListener listener) {
        MFundMediaUploadRequest request = new MFundMediaUploadRequest();
        request.setClientCode(clientCode);
        request.setPanNo(panNumber);
    ...
    public static void sendRequestKYC(JSONObject request, Context ctx, ServiceResponseListener listener) {
        ...
        jsonRequest.setService(KYC_SVC_GROUP, KYC_SVC_NAME);
    ...
    public static void sendRequestUpload(JSONObject request, Context ctx, ServiceResponseListener listener) {
        ...
        jsonRequest.setService(ALREADY_UPLOAD_PHOTO_SVC_GROUP, ALREADY_UPLOAD_PHOTO_SVC_GROUP);
        ServiceManager.getInstance(ctx).sendRequest(jsonRequest, listener);
    }
