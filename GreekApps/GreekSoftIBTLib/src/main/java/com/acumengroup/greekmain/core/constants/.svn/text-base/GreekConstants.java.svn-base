...
public interface GreekConstants extends LabelConfig, ServiceConstants {
    ...
    int NAV_TO_SAUDA_REPORT = 500;
    int NAV_TO_PORTFOLIO_REPORT = 501;
    int NAV_TO_TRANSACTION_REPORT = 502;
    int NAV_TO_P_AND_L_DETAIL_REPORT = 503;
    int NAV_TO_FINANCIAL_STM_REPORT = 504;
    int NAV_TO_LEDGER_DETAIL_REPORT = 505;
