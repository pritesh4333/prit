...
import com.acumengroup.mobile.chartiqscreen.ui.StickyHeaderAdapter;
...
public class StudiesAdapter extends RecyclerView.Adapter<StudiesAdapter.ViewHolder> implements
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        ...
        if (i != 0) {
            ...
            return new StubViewHolder(new View(mInflater.getContext()), new GreekTextView(mInflater.getContext()));
        }
    }
    ...
    static class ViewHolder extends RecyclerView.ViewHolder {
        public GreekTextView textView;
        public ImageView imageButton;
        RelativeLayout parentlayout;

        public ViewHolder(View itemView) {
            super(itemView);
            textView = (GreekTextView) itemView.findViewById(R.id.text_item);
            imageButton = (ImageView) itemView.findViewById(R.id.image_button);
            parentlayout = (RelativeLayout) itemView.findViewById(R.id.parent_layout);
            if(AccountDetails.getThemeFlag(ctx).equalsIgnoreCase("white")){

                parentlayout.setBackground(ctx.getDrawable(R.drawable.bg_drawable_white));
                textView.setTextColor(ctx.getColor(AccountDetails.textColorDropdown));
                textView.setBackgroundColor(ctx.getColor(AccountDetails.backgroundColor));
    ...
    static class StubViewHolder extends ViewHolder {
        public StubViewHolder(View itemView, GreekTextView textView) {
            super(itemView);
    ...
    static class HeaderHolder extends RecyclerView.ViewHolder {
        public GreekTextView header;

        public HeaderHolder(View itemView) {
            super(itemView);
            header = (GreekTextView) itemView.findViewById(R.id.text_header);
        }
    }
