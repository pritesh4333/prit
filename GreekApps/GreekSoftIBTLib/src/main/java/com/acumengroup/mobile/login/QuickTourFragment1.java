    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        if(layoutResId == R.layout.quickintro2){
            ...
            if (packagname.equalsIgnoreCase("com.vishwas.mobile")){
                ...
                layout.setBackground(getActivity().getResources().getDrawable(R.mipmap.mandot_scrip_intro));
                ...
                layout.setBackground(getActivity().getResources().getDrawable(R.drawable.cliqtrade_scrip_intro));
            }
            ...
            if (packagname.equalsIgnoreCase("com.vishwas.mobile")){
                ...
                layout.setBackground(getActivity().getResources().getDrawable(R.mipmap.mandot_watchlist_intro));
            }else  if (packagname.equalsIgnoreCase("com.msfl.mobile")){
                layout.setBackground(getActivity().getResources().getDrawable(R.drawable.watchlist_intro));
            }else  if (packagname.equalsIgnoreCase("com.clicktrade.mobile")){
                layout.setBackground(getActivity().getResources().getDrawable(R.drawable.cliqtrade_watchlist_intro_));
            }
