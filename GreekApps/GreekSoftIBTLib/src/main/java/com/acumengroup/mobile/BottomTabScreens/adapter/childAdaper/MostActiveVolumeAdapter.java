...
public class MostActiveVolumeAdapter extends RecyclerView.Adapter<MostActiveVolumeAdapter.MyViewHolder> {
    List<GainerData_v2> gainerData;
    AppCompatActivity activity;
    private ArrayList tokenArrayList = new ArrayList();

    public MostActiveVolumeAdapter(List<GainerData_v2> gainerData, AppCompatActivity activity) {
