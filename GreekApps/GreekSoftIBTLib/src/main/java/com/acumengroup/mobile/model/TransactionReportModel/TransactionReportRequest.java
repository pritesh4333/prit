...
public class TransactionReportRequest implements GreekRequestModel, GreekResponseModel {
...
//        request.setDate(endDate);
    ...
    public static void sendRequest(JSONObject request, String ServiceName, Context ctx, ServiceResponseListener listener) {
        ...
        jsonRequest.setResponseClass(TransactionReportResponse.class);
        jsonRequest.setService("getTransactionReport_Phillip", ServiceName);
        jsonRequest.setService("portfolio", "getTransactionReport_Phillip");
