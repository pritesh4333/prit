...
public class CommodityMarketMoveAdapter extends RecyclerView.Adapter<CommodityMarketMoveAdapter.MyViewHolder> {
    List<GainerData> gainerData;
    AppCompatActivity activity;
    private ArrayList tokenArrayList = new ArrayList();

    public CommodityMarketMoveAdapter(List<GainerData> gainerData, AppCompatActivity activity) {
