...
//    private GreekEditText reset_mpin_edit_one, reset_mpin_edit_two, reset_mpin_edit_three, reset_mpin_edit_four, reset_mpin_edit_five, reset_mpin_edit_six;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.customer_new_login);
        ...
        try {
                ...
                FirebaseMessaging.getInstance().getToken()
                        .addOnCompleteListener(new OnCompleteListener<String>() {
                            ...
                            public void onComplete(@NonNull com.google.android.gms.tasks.Task<String> task) {
                                ...
                                ValidateGuestRequest.sendRequestFlags(LoginActivity.this,deviceId, serviceResponseHandler);
            ...
            if(!AccountDetails.getLogin_compliance().isEmpty()) {
                if (Integer.parseInt(AccountDetails.getLogin_compliance()) > 0) {
                    String passwords = Util.getPrefs(this).getString("GREEK_RETAINED_CUST_PASS", "");
                    if (passwords.isEmpty()) {
                        // normal login and password flow and then otp and then home screen
                        AccountDetails.clearCache(getApplicationContext());
                    } else {
                        String storedDate = Util.getPrefs(this).getString("GREEK_CURRENT_DATE", "");
                        if (!storedDate.isEmpty() & storedDate.equalsIgnoreCase(currentDate)) {
                            String password = Util.getPrefs(this).getString("GREEK_RETAINED_CUST_PASS", "");
                            ...
                            // direct otp screen and then home screen
                            if (!ClientOtp.isEmpty() && !ClientOtpUserName.isEmpty() && !password.isEmpty()) {
                                ...
                                RelativeLayout customProgress = layout.findViewById(R.id.customProgress);
                                GreekEditText otp = layout.findViewById(R.id.otp_edittext);
                                final GreekTextView resendText = layout.findViewById(R.id.txt_resend_otp);
                                otp.setHint("Enter Last Otp Received");
                                otp.setHintTextColor(getResources().getColor(com.acumengroup.mobile.R.color.black));
                                resendText.setClickable(true);
                                resendText.setTextColor(getResources().getColor(com.acumengroup.mobile.R.color.black));
                                submit.setOnClickListener(new View.OnClickListener() {
                                    @Override
                                    public void onClick(View v) {
                                        if (TextUtils.isEmpty(otp.getText().toString())) {
                                            otp.setError("Enter Last Otp Received");
                                        } else if (TextUtils.isEmpty(edUser.getText().toString().trim())) {
                                            edUser.setError("Enter User Name ");
                                        } else {


                                            loginWithOTP = otp.getText().toString();
                                            if (ClientOtp.contains(loginWithOTP)) {
                                                deviceId = Settings.Secure.getString(LoginActivity.this.getContentResolver(), Settings.Secure.ANDROID_ID);//todo pk
                                                String manufacturer = getDeviceName();
                                                String model = Build.MODEL;
                                                int version = Build.VERSION.SDK_INT;
                                                String deviceDetails = manufacturer + "-" + model + "-" + version;
                                                streamController.sendStreamingLoginRequest(getApplicationContext(), AccountDetails.getUsername(getApplicationContext()), AccountDetails.getClientCode(getApplicationContext()), AccountDetails.getSessionId(getApplicationContext()), AccountDetails.getToken(getApplicationContext()), null, null);
                                                orderStreamingController.sendStreamingLoginRequest(getApplicationContext(), AccountDetails.getUsername(getApplicationContext()), AccountDetails.getClientCode(getApplicationContext()), AccountDetails.getSessionId(getApplicationContext()), AccountDetails.getToken(getApplicationContext()));
                                                if (snackbar != null) {
                                                    snackbar.dismiss();
                                                }
...
//                    }
                                                ...
                                                new HeartBeatService(LoginActivity.this, AccountDetails.getUsername(getApplicationContext()), AccountDetails.getSessionId(getApplicationContext()),
                                                        AccountDetails.getClientCode(getApplicationContext())).start();
                                                finish();
                                            } else {
                                                otp.setError("Otp not match");
                                            }
                                ...
                                resendText.setOnClickListener(new View.OnClickListener() {
                                    ...
                                    public void onClick(View v) {
                                        if (TextUtils.isEmpty(edUser.getText().toString().trim())) {
                                            ...
                                            resendText.setTextColor(getResources().getColor(com.acumengroup.mobile.R.color.gray_border));
                                            Toast.makeText(LoginActivity.this, "Resend OTP has been sent to your registered mobile number", Toast.LENGTH_LONG).show();
                                            LoginWithOTPRequest.sendRequest(edUser.getText().toString().trim(), "", LoginActivity.this, serviceResponseHandler);
                                        }
                                    }
                                });
                                ...
                                levelDialog.getWindow().addFlags(WindowManager.LayoutParams.FLAG_BLUR_BEHIND);
                                levelDialog.show();

                            } else {
                                // Otp not match
                                SharedPreferences.Editor speditor = Util.getPrefs(this).edit();
                                speditor.putString("GREEK_CURRENT_DATE", currentDate);
                                speditor.apply();
                                speditor.commit();

                                Toast.makeText(LoginActivity.this, "OTP has been sent to your registered mobile number", Toast.LENGTH_LONG).show();
                                LoginWithOTPRequest.sendRequest( Util.getPrefs(this).getString("GREEK_RETAINED_CUST_UNAME", ""), "", LoginActivity.this, serviceResponseHandler);
                                LayoutInflater inflater = getLayoutInflater();
                                View layout = inflater.inflate(R.layout.alert_validate_otp, null, false);
...
//                    }
                                ...
                                submit.setOnClickListener(new View.OnClickListener() {
                                    ...
                                    public void onClick(View v) {
                                        if (TextUtils.isEmpty(otp.getText().toString())) {
                                            ...
                                            int version = Build.VERSION.SDK_INT;
                                            String deviceDetails = manufacturer + "-" + model + "-" + version;
                                            ValidateLoginOTPRequest.sendRequest(edUser.getText().toString().trim(), otp.getText().toString(),
                    ...
                    String ClientOtp = Util.getPrefs(this).getString("GREEK_RETAINED_LOGIN_OTP", "");
                    String ClientOtpUserName = Util.getPrefs(this).getString("GREEK_RETAINED_LOGIN_OTP_CUST_UNAME", "");
                    if (AskForMpin && !ClientOtp.isEmpty() && !ClientOtpUserName.isEmpty() && !ClientOtp.isEmpty() && !ClientOtpUserName.isEmpty() && password.isEmpty()) {

                        // login with otp because user otp is allready store in SP
...
//                    String transpass = Util.getPrefs(this).getString("GREEK_RETAINED_CUST_TRANS_PASS", "");
                        ...
                        String ClientOtps = Util.getPrefs(this).getString("GREEK_RETAINED_LOGIN_OTP", "");
                        loginWithOTP = ClientOtps.replace(Util.getPrefs(this).getString("GREEK_RETAINED_CUST_UNAME", ""), "");
                        deviceId = Settings.Secure.getString(LoginActivity.this.getContentResolver(), Settings.Secure.ANDROID_ID);//todo pk
                        String manufacturer = getDeviceName();
                        String model = Build.MODEL;
                        int version = Build.VERSION.SDK_INT;
                        String deviceDetails = manufacturer + "-" + model + "-" + version;
                        ValidateLoginOTPRequest.sendRequest(username, loginWithOTP,
                                "", LoginActivity.this, deviceId, deviceDetails, "0", serviceResponseHandler);
                    } else {
                        if (AskForMpin) {
                            /// MPIN created successfully now validating MPIN
...
//                    String transpass = Util.getPrefs(this).getString("GREEK_RETAINED_CUST_TRANS_PASS", "");
            ...
            if (fromActivity != null) {
                if (fromActivity.equalsIgnoreCase("heartBeat")) {
                    ...
                    GreekDialog.alertDialog(this, 0, alert_title, "Invalid Session.Heart Beat stopped", "Ok", false, new GreekDialog.DialogListener() {
        ...
        if(!AccountDetails.getLogin_compliance().isEmpty()){
            if(Integer.parseInt( AccountDetails.getLogin_compliance()) > 0) {
                txtloginwitOTP.setVisibility(View.INVISIBLE);
            }else{
                txtloginwitOTP.setVisibility(View.VISIBLE);
            }
        }else{
        ...
        appUpdateInfoTask.addOnSuccessListener(appUpdateInfo -> {
            if (appUpdateInfo.updateAvailability() == UpdateAvailability.UPDATE_AVAILABLE
                ...
                // Request the update.
                vCode = Util.getPrefs(this).getInt("availableVersionCode", 0);

                if (vCode != appUpdateInfoTask.getResult().availableVersionCode() || vCode < appUpdateInfoTask.getResult().availableVersionCode()) {
...
//
    ...
    private void setupView() {
        ...
        if(appname.equalsIgnoreCase("Vishwas")) {
            ...
            txtOpenAcct.setVisibility(View.VISIBLE);
            product_logo.setVisibility(View.VISIBLE);
            product_logo.setImageDrawable(getResources().getDrawable(R.drawable.philips_login_icon));
        }else if(appname.equalsIgnoreCase("Pentagon")){
            btnSignUp.setVisibility(View.GONE);
            txtOpenAcct.setVisibility(View.GONE);
            product_logo.setVisibility(View.VISIBLE);
            product_logo.setImageDrawable(getResources().getDrawable(R.drawable.cliqtrade_icon));
        }else if(appname.equalsIgnoreCase("Mandot")) {
            product_logo.setVisibility(View.VISIBLE);
            product_logo.setImageDrawable(getResources().getDrawable(R.drawable.mandot_login_icon));
        }
        ...
        String appname1 =Util.getPrefs(this).getString("AppName","");
        if(appname1.equalsIgnoreCase("Vishwas")) {
            vishwas_txtbottom.setVisibility(View.VISIBLE);
        }
...
//MPIN CREATE EXITTEXT LINSTNER END
    ...
    public void onClick(View view) {
        ...
        String packagname = getPackageName();
        String disclaimer;
        if (packagname.equalsIgnoreCase("com.clicktrade.mobile")){
            disclaimerstring = getString(R.string.disclaimer);
            disclaimer = disclaimerstring.replaceAll("APPNAME", "Cliqtrade");
            disclaimer = disclaimer.replaceAll("Cliqtrade \\(India\\) Pvt. Ltd", "Pentagon Stock Brokers Pvt. Ltd.");
        }else{
            disclaimer=disclaimerstring.replaceAll("APPNAME",GreekBaseActivity.GREEK);
        }
        int id = view.getId();
        if (id == R.id.txtdisclaimer) {
            ...
            ;
            GreekDialog.alertDialogOnly(LoginActivity.this, alert_title, formatEulaText.toString());
        } else if (id == R.id.create_mipn_disclaimer) {
            getApplicationContext().setTheme(R.style.GREEKTheme1);
            final CharSequence create_mipn_disclaimer = Html.fromHtml(disclaimer);
            ;
            GreekDialog.alertDialogOnly(LoginActivity.this, alert_title, create_mipn_disclaimer.toString());
        } else if (id == R.id.login_mipn_disclaimer) {
            getApplicationContext().setTheme(R.style.GREEKTheme1);
            final CharSequence login_mipn_disclaimer = Html.fromHtml(disclaimer);
            ;
            GreekDialog.alertDialogOnly(LoginActivity.this, alert_title, login_mipn_disclaimer.toString());
        } else if (id == R.id.otp_mipn_disclaimer) {
            getApplicationContext().setTheme(R.style.GREEKTheme1);
            final CharSequence otp_mipn_disclaimer = Html.fromHtml(disclaimer);
            ;
            GreekDialog.alertDialogOnly(LoginActivity.this, alert_title, otp_mipn_disclaimer.toString());
        } else if (id == R.id.reset_mipn_disclaimer) {
            getApplicationContext().setTheme(R.style.GREEKTheme1);
            final CharSequence reset_mipn_disclaimer = Html.fromHtml(disclaimer);
            ;
            GreekDialog.alertDialogOnly(LoginActivity.this, alert_title, reset_mipn_disclaimer.toString());
...
//                startActivity(intent);
                String url ="";
                if (AccountDetails.geteKycSignUpPort().isEmpty() || AccountDetails.geteKycSignUpPort() == null ){
                    if(!AccountDetails.geteKycSignUpUrl().isEmpty()) {
                        url = AccountDetails.geteKycSignUpUrl();
                        startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse(url)));
                    }

                }else{
                    if(!AccountDetails.geteKycSignUpUrl().isEmpty()){
                        url= AccountDetails.geteKycSignUpUrl()+":"+AccountDetails.geteKycSignUpPort();
                        startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse(url)));
                    }
            ...
            } else if (appname.equalsIgnoreCase("MSFL")) {
...
//                startActivity(i);
                ...
                String MxmlURL = "https://tradeongo.com/sign-up.php";
                ...
                String VxmlURL = "https://kyc.meon.space/mandot/signup";
                Intent intent = new Intent(getApplicationContext(), WebContent.class);
                intent.putExtra("AtomRequest", VxmlURL);
                intent.putExtra("uniqueid", "");
                intent.putExtra("amt", "");
            ...
            signUpAsGuest(view);
//                GreekDialog.alertDialogOnly(LoginActivity.this, alert_title, getString(R.string.SEBI_STRING));
//                signUpAsGuest(view);
            ...
            if (TextUtils.isEmpty(edUser.getText().toString().trim().trim())) {
                edUser.setError("Enter Client Code");
            } else {
                progressLayout.setVisibility(View.VISIBLE);
                txtloginwitOTP.setClickable(false);
                txtloginwitOTP.setTextColor(getResources().getColor(com.acumengroup.mobile.R.color.gray_border));
                Toast.makeText(LoginActivity.this,"OTP has been sent to your registered mobile number",Toast.LENGTH_LONG).show();
                LoginWithOTPRequest.sendRequest(edUser.getText().toString().trim(), "", LoginActivity.this, serviceResponseHandler);
    ...
    private void proceedToLogin() {
        ...
        brokerId = "1";
        userCode = edUser.getText().toString().trim();
        userPass = edPass.getText().toString().trim();

        if (edTPass.getVisibility() == View.VISIBLE) {

            transactionPass = edTPass.getText().toString().trim();
        } else {
            transactionPass = "";
        }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == REQUEST_CODE) {
            if (resultCode != RESULT_OK) {
                ...
                editor1.putInt("availableVersionCode", appUpdateInfoTask.getResult().availableVersionCode());
                editor1.apply();
                editor1.commit();
...
//                    }
                    ...
                    GreekDialog.alertDialog(LoginActivity.this, 0, alert_title, getString(R.string.CP_MPIN_INVALID_MSG), "Ok", false, new GreekDialog.DialogListener() {
            ...
            try {
                ...
                if (loginResponse.getErrorCode().equalsIgnoreCase("0")) {
                    ...
                    GreekDialog.alertDialog(LoginActivity.this, 0, alert_title, getString(R.string.CP_MPIN_NOTCREATED_MSG), "Ok", false, new GreekDialog.DialogListener() {
                    ...
                    GreekDialog.alertDialog(LoginActivity.this, 0, alert_title, getString(R.string.CP_FAILURE_MSG), "Ok", false, new GreekDialog.DialogListener() {
            ...
            try {
                ...
                if (loginResponse.getErrorCode().equalsIgnoreCase("0")) {
                    ...
                    GreekDialog.alertDialog(LoginActivity.this, 0, alert_title, getString(R.string.CP_OTP_INVALID_MSG), "Ok", false, new GreekDialog.DialogListener() {
            ...
            try {
                ...
                if (loginResponse.getErrorCode().equalsIgnoreCase("0")) {
                    ...
                    GreekDialog.alertDialog(this, 0, alert_title, getString(R.string.CP_USER_PASSWORD_INVALID_MSG),
                    ...
                    GreekDialog.alertDialog(this, 0, alert_title, getString(R.string.CP_FAILURE_MSG),
                            "Ok", false, new GreekDialog.DialogListener() {
                    ...
                    GreekDialog.alertDialog(this, 0, alert_title, getString(R.string.CP_DUPLICATE_MSG), "Ok", false, new GreekDialog.DialogListener() {
                    ...
                    GreekDialog.alertDialog(this, 0, alert_title, getString(R.string.LP_MAX_ATTEMPTS_MSG), "Ok", false, new GreekDialog.DialogListener() {
                    ...
                    GreekDialog.alertDialog(this, 0, alert_title, getString(R.string.CP_USER_SUSPENDED), "Ok", false, new GreekDialog.DialogListener() {
                    ...
                    GreekDialog.alertDialog(this, 0, alert_title, "Same Login and Transaction Password", "Ok", false, new GreekDialog.DialogListener() {
                    ...
                    GreekDialog.alertDialog(this, 0, alert_title, "Retailer does not exist", "Ok", false, new GreekDialog.DialogListener() {
                    ...
                    GreekDialog.alertDialog(this, 0, alert_title, "Version Mismatch.Please Update your Application", "Ok", false, new GreekDialog.DialogListener() {
                    ...
                    GreekDialog.alertDialog(this, 0, alert_title, "Account Locked.Please Contact Admin and Change Password", "Ok", false, new GreekDialog.DialogListener() {
                ...
                if (PassTypeCode.equalsIgnoreCase("0")) {
                    ...
                    if (loginResponse.getExecutionCode() != null && loginResponse.getExecutionCode().equals("0")) {
                        ...
                        if (errorCode.equals("21")) {
                            ...
                            GreekDialog.alertDialog(this, 0, alert_title, getString(R.string.CP_PASSWORD_EXPIRED_MSG), "Ok", false, new GreekDialog.DialogListener() {
                            ...
                            GreekDialog.alertDialog(this, 0, alert_title, getString(R.string.CP_BOTH_PASSWORD_EXPIRED_MSG), "Ok", false, new GreekDialog.DialogListener() {
                        ...
                        GreekDialog.alertDialog(this, 0, alert_title, getString(R.string.CP_LOGIN_ERROR_MSG), "Ok", false, new GreekDialog.DialogListener() {
                    ...
                    if (loginResponse.getExecutionCode() != null && loginResponse.getExecutionCode().equals("0")) {
                        ...
                        if (errorCode.equals("1")) {
                            GreekDialog.alertDialog(LoginActivity.this, 0, alert_title, getString(R.string.CP_TRANS_PASSWORD_EXPIRED_MSG), "Ok", false, new GreekDialog.DialogListener() {
                            ...
                            GreekDialog.alertDialog(LoginActivity.this, 0, alert_title, getString(R.string.CP_USER_TRANS_PASSWORD_INVALID_MSG), "Ok", false, new GreekDialog.DialogListener() {
                            ...
                            GreekDialog.alertDialog(LoginActivity.this, 0, alert_title, getString(R.string.CP_DUPLICATE_MSG), "Ok", false, new GreekDialog.DialogListener() {
                            ...
                            GreekDialog.alertDialog(LoginActivity.this, 0, alert_title, getString(R.string.TP_MAX_ATTEMPTS_MSG), "Ok", false, new GreekDialog.DialogListener() {
                            ...
                            GreekDialog.alertDialog(LoginActivity.this, 0, alert_title, getString(R.string.CP_INACTIVE_MSG), "Ok", false, new GreekDialog.DialogListener() {
                            ...
                            GreekDialog.alertDialog(LoginActivity.this, 0, alert_title, getString(R.string.CP_INVALID_2FA_MSG), "Ok", false, new GreekDialog.DialogListener() {
...
//unused code
            ...
            try {
                ...
                if (errorCode.equals("1")) {
                    GreekDialog.alertDialog(this, 0, alert_title, "Your password is expired. Please change the password to continue", "Ok", false, new GreekDialog.DialogListener() {
                    ...
                    GreekDialog.alertDialog(this, 0, alert_title, "Invalid user or password", "Ok", false, new GreekDialog.DialogListener() {
                    ...
                    GreekDialog.alertDialog(this, 0, alert_title, "Failure", "Ok", false, new GreekDialog.DialogListener() {
                    ...
                    GreekDialog.alertDialog(this, 0, alert_title, "Duplicate Login", "Ok", false, new GreekDialog.DialogListener() {
                    ...
                    GreekDialog.alertDialog(this, 0, alert_title, "Version Mismatch.Please Update your Apk", "Ok", false, new GreekDialog.DialogListener() {
...
//                    }
            ...
            try {
                ...
                if (errorCode.equals("0")) {
                    GreekDialog.alertDialog(this, 0, alert_title, getString(R.string.LP_FORGOT_ANSWER), "Ok", false, new GreekDialog.DialogListener() {
            ...
            try {
                try {
                    txtloginwitOTP.setClickable(true);
                    txtloginwitOTP.setTextColor(getResources().getColor(com.acumengroup.mobile.R.color.blue_text));
                ...
                if (errorCode.equals("21")) {
                    ...
                    LoginWithOTPRequest.sendRequest(edUser.getText().toString().trim(), BaseURL, LoginActivity.this, serviceResponseHandler);
...
//                    }
                    ...
                    editor.commit();
                    GreekDialog.alertDialog(LoginActivity.this, 0, alert_title, getString(R.string.CP_USER_SUSPENDED), "Ok", false, new GreekDialog.DialogListener() {
                    ...
                    GreekDialog.alertDialog(LoginActivity.this, 0, alert_title, "Retailer does not exist", "Ok", false, new GreekDialog.DialogListener() {
                    ...
                    GreekDialog.alertDialog(LoginActivity.this, 0, alert_title, "Account Locked. Please Contact Admin and Change Password", "Ok", false, new GreekDialog.DialogListener() {
            ...
            try {
                ...
                if (loginResponse.getErrorCode().equals("21")) {
                    ...
                    int version = Build.VERSION.SDK_INT;
                    String deviceDetails = manufacturer + "-" + model + "-" + version;
                    ValidateLoginOTPRequest.sendRequest(edUser.getText().toString().trim(), loginWithOTP, BaseURL, LoginActivity.this,
                ...
                if (loginResponse.getClientCode().equalsIgnoreCase("null")) {
                    GreekDialog.alertDialog(this, 0, alert_title, "Please Enter Valid OTP",
                            "Ok", false, new GreekDialog.DialogListener() {
                    ...
                    if (PassTypeCode.equalsIgnoreCase("0")) {
                        ...
                        if (loginResponse.getValidate2FA().equalsIgnoreCase("false")) {
                            ...
                            editor.putString("GREEK_RETAINED_CUST_PASS", userPass);
                            editor.putString("GREEK_RETAINED_BROKER_ID", brokerId);
                            editor.putString("GREEK_RETAINED_LOGIN_OTP", userCode+loginWithOTP);
                            editor.putString("GREEK_RETAINED_LOGIN_OTP_CUST_UNAME", userCode+userCode);
...
//new end
    ...
    public void infoDialog(int action, String msg, JSONResponse jsonResponse) {
        ...
        if (action == ActionCode.ACT_CODE_OK.value) {
            GreekDialog.alertDialog(LoginActivity.this, 0, alert_title, msg, "OK", true, null);
        }
    }
