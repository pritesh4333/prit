...
public class CommodityRecycleChildAdapterSingle extends RecyclerView.Adapter<CommodityRecycleChildAdapterSingle.MyViewHolder> {
    ...
    public CommodityRecycleChildAdapterSingle(ArrayList<GainerData> gainerData, AppCompatActivity activity, String groupPosition, String header, int chlidindex) {
