...
import com.acumengroup.mobile.upi.UPITransferFragment;
...
public class GreekBaseActivity extends AppCompatActivity implements GreekUIServiceHandler, GreekConstants, SingleUploadBroadcastReciever.Delegate  {
    ...
    private String amount, order_state, order_state_msg,segmentstr = "";
...
//
        ...
        try {
            appUpdateManager = AppUpdateManagerFactory.create(GreekBaseActivity.this);
            appUpdateManager
                    .getAppUpdateInfo()
    ...
    private void popupSnackbarForCompleteUpdate() {
        Snackbar snackbar =
                Snackbar.make(
                        ...
                        Snackbar.LENGTH_INDEFINITE).setDuration(10000);
    ...
    protected void onResume() {
        ...
        if (AccountDetails.getHeartBeatApolloCount() > 3) {
            Log.e("GreekBaseOnCapture","camera open");
    ...
    protected void onPause() {
        ...
        if (networkChangeReceiver != null && !AccountDetails.getIsMainActivity()&& !isthemeApplied.equalsIgnoreCase("true")) {
            try {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            if (isInPictureInPictureMode()) {
                ...
                if (!AccountDetails.getIsMainActivity()&&!isthemeApplied.equalsIgnoreCase("true")) {
    ...
    public void updateBroadcastData(StreamerBroadcastResponse response) {
        try {
            ...
            OverviewTabFragment.txt_nifty_value = niftyTxt.getText().toString().trim();
            OverviewTabFragment.txt_sensex_value =sensextxt.getText().toString().trim();
            OverviewTabFragment.niftyValuetxtvalue =niftyValueTxt.getText().toString().trim();
            OverviewTabFragment.sensexValuetxtvalue = sensexValueTxt.getText().toString().trim();
            OverviewTabFragment.niftychangetxtvalue = niftyChngTxt.getText().toString().trim();
            OverviewTabFragment.sensexchangetxtvalue = sensexChngTxt.getText().toString().trim();

            OverviewTabFragment.firstSymbolNametxtvalue = firstsymbolTxt.getText().toString().trim();
            OverviewTabFragment.secondSymboltxtvalue = secondSymbolTxt.getText().toString().trim();
            OverviewTabFragment.thirdSymbolnametxtvalue = thirdsymbolTxt.getText().toString().trim();

            OverviewTabFragment.firstvaluevalue = firstvalueTxt.getText().toString().trim();
            OverviewTabFragment.secondvaluevalue = secondvalueTxt.getText().toString().trim();
            OverviewTabFragment.thirdvaluevalue = thrdvalueTxt.getText().toString().trim();
            OverviewTabFragment.firstchangevalue = firstChngTxt.getText().toString().trim();
            OverviewTabFragment.secondchangevalue = secondChnagTxt.getText().toString().trim();
            OverviewTabFragment.thirdchangevalue = thrdChngTxt.getText().toString().trim();
...
//            AccountDetails.globalArg = getCurrentFragmentByName("chartingfragment").getArguments();
    ...
    public void refreshFragment() {
        ...
        if (AccountDetails.currentFragment == NAV_TO_PENDING_TAB_SCREEN) {
            ...
            setupFragment(new AlertFragment());
        } else if(AccountDetails.currentFragment == NAV_TO_PORTFOLIO_POSITION_SCREEN) {
            //(new AlertFragment());

            Bundle args = new Bundle();
            PortfolioBottomFragment positionsTabFragment = new PortfolioBottomFragment();
            args.putString("from", "dashboard");
            positionsTabFragment.setArguments(args);
            setupFragment(positionsTabFragment);
        }/* else if(AccountDetails.currentFragment == NAV_TO_PORTFOLIO_DASHBOARD_SCREEN) {
            //(new AlertFragment());
        ...
        menuList.setOnChildClickListener(new ExpandableListView.OnChildClickListener() {
            ...
            public boolean onChildClick(ExpandableListView parent, View v, final int position, final int childPosition, long id) {
                ...
                if (USER_TYPE == USER.OPENUSER) {
                    ...
                    }else if (groupList.get(position).getTitle().equalsIgnoreCase(getString(R.string.GREEK_MENU_UPI))) {
                       /* Intent intent = new Intent(GreekBaseActivity.this, WebViewUPI.class);
                        ...
                        handleExternalLinks(clickedPosDetails);
                    }else if (groupList.get(position).getTitle().equalsIgnoreCase(getString(R.string.GREEK_MENU_EDIS_TXT))) {
                        if(clickedPosDetails.equalsIgnoreCase(GREEK_MENU_MARGIN_PLEDGE)){
//                            Toast.makeText(GreekBaseActivity.this,"Click",Toast.LENGTH_SHORT).show();
                            ...
                            //startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://classplus.phillipcapital.in/Classplus/(S(p1yhhwibdpm0rgrouc2aggcy))/Login/AppLogin.aspx")));
                            drawerLayout.closeDrawers();
                        }
                        if(clickedPosDetails.equalsIgnoreCase(GREEK_MENU_EDIS_DASHBOARD)){
//                            Toast.makeText(GreekBaseActivity.this,"Click",Toast.LENGTH_SHORT).show();
                            performMenuAction(clickedPosDetails);
                        } if(clickedPosDetails.equalsIgnoreCase(GREEK_MENU_EDIS_TRANSACTION_DETAILS)){
//                            Toast.makeText(GreekBaseActivity.this,"Click",Toast.LENGTH_SHORT).show();
                            performMenuAction(clickedPosDetails);
                        }
                    } else {
            ...
            public boolean onGroupClick(ExpandableListView expandableListView, View view, int position, long l) {
                ...
                if (GreekBaseActivity.USER_TYPE == USER.OPENUSER) {
                    ...
                    if (groupList.get(position).getTitle().equalsIgnoreCase(getString(R.string.GREEK_MENU_CHARTING))) {
                        ...
                        startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse(AccountDetails.getIpo_url())));
                        drawerLayout.closeDrawers();
                        ...
                        AccountDetails.setLastSelectedGroup("");
                        finish();
                    }else if (groupList.get(position).getTitle().equalsIgnoreCase(getString(R.string.GREEK_MENU_EKYC))) {

                        drawerLayout.closeDrawers();
//                        MarshMallowPermission marshMallowPermission;
//                        marshMallowPermission = new MarshMallowPermission(GreekBaseActivity.this);
...
//
                ...
                } else if (GreekBaseActivity.USER_TYPE == USER.IBTCUSTOMER||GreekBaseActivity.USER_TYPE == USER.CUSTOMER) {
                    PortraitMode();
                    if (groupList.get(position).getTitle().equalsIgnoreCase(getString(R.string.GREEK_MENU_EDIS_TXT))) {
                       ...
                       /* Intent intent = new Intent(GreekBaseActivity.this, WebViewUPI.class);
                        ...
                        AccountDetails.setIsMainActivity(true);*/
                         ...
                         showAppbar();
                        setMenuSelection[0] = true;
                        ShowUPITransferScreen();
                        performMenuAction(GREEK_MENU_UPI);
                        drawerLayout.closeDrawers();
                        clickHandled = true;
...
//
    ...
    private void ShowUPITransferScreen() {
        setupFragment(new UPITransferFragment());
    }
    ...
    private void handleExternalLinks(String det) {
        switch (det) {
            ...
            case GREEK_SSL_LINKS_TXT:
                startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse(AccountDetails.getSsl_url())));
                break;
            ...
            case GREEK_BACK_OFFICE_LINKS_TXT:
                startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse(AccountDetails.getBo_office_url())));
                break;
            case GREEK_OFFLINE_BANK_LINKS_TXT:
                startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse(AccountDetails.getFt_offline_url())));
                break;
        }
    }
    ...
    public void doLogout(final int status) {
        ...
        Util.getPrefs(GreekBaseActivity.this).edit().putString("GREEK_RETAINED_LOGIN_OTP", "").apply();
        Util.getPrefs(GreekBaseActivity.this).edit().putString("GREEK_RETAINED_LOGIN_OTP_CUST_UNAME", "").apply();
...
//            AccountDetails.setTextColorDropdown(R.color.textColorCustom);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        else if (requestCode == CDSLREQUESTCODE) {
...
//            JSONObject jObj = new JSONObject(text);
                ...
                GreekDialog.alertDialog(GreekBaseActivity.this, 0, GreekBaseActivity.GREEK, payINMessage, "Ok", false, new GreekDialog.DialogListener() {
                    @Override
                    public void alertDialogAction(GreekDialog.Action action, Object... data) {
                    }
                });
            ...
            order_state = "2";
            String segStr = "";
            if (mapofresponse != null) {
                if (mapofresponse.get("prod").equalsIgnoreCase("MCX") || mapofresponse.get("prod").equalsIgnoreCase("NCDX")) {
                    segStr = "1";
                } else {
                    segStr = "2";
                }
//            Transaction initiated updated on Aracane
                FundTransferCancelRequest.sendRequest(AccountDetails.getClientCode(GreekBaseActivity.this),
                        AccountDetails.getSessionId(GreekBaseActivity.this), mapofresponse.get("mer_txn"),
                        "", GreekBaseActivity.this, serviceResponseHandler);
//           order Transaction initiated updated onIris
                orderStreamingController.sendFundTransferDetailsRequest(GreekBaseActivity.this,
                        mapofresponse.get("mer_txn"),
                        AccountDetails.getUsername(GreekBaseActivity.this), amount, order_state,
                        AccountDetails.getClientCode(GreekBaseActivity.this), segStr);
            ...
            File f;
            try {
                String cameraPath = Environment.getExternalStorageDirectory().toString()
                        + File.separator
                        + "Pictures"
                        + File.separator
                        + fileName;
    ...
    public void uploadMultipart(String cameraPath) {
        ...
        Uri filePath= Uri.fromFile(new File(cameraPath));
...
/*            for (int i = 0; i < hashMapWatchListData.size(); i++) {
    ...
    public void handleResponse(Object response) {
        ...
        else if (MARKETS_SVC_GROUP.equals(jsonResponse.getServiceGroup()) && SENDAUTHREQUESTNSDL_SVC_NAME.equals(jsonResponse.getServiceName())) {
            try {
                Gson gson = new Gson();
                ...
                Intent intent = new Intent(GreekBaseActivity.this, WebContentNSDL.class);
...
//        mRrootLayout.invalidate();
    ...
    private void showPoaPopup() {
        ...
        if (AccountDetails.getDPType().equalsIgnoreCase("NSDL")){
            dmessage.setText("Dear Investor You are not allowed to Sell this Stock due to Non Submission of POA \n\n You can Sell this Stock by authorizing it on NSDL (Depository participant) as per New Regulations");
        }else{
            dmessage.setText("Dear Investor You are not allowed to Sell this Stock due to Non Submission of POA \n\n You can Sell this Stock by authorizing it on CDSL (Depository participant) as per New Regulations");
        }

        String packagname =  getApplicationContext().getPackageName();
        if (packagname.equalsIgnoreCase("com.vishwas.mobile")){
...
//            poalogo.setLayoutParams(layoutParams);
    ...
    private void showAuthorizePopup() {
        ...
        ImageView imgICon = authDialogView.findViewById(R.id.imgICon);
        ...
        if (AccountDetails.getDPType().equalsIgnoreCase("NSDL")){
            authDialogView.findViewById(R.id.btn_to_cdsl).setVisibility(View.GONE);
            authDialogView.findViewById(R.id.forgot_tpin).setVisibility(View.GONE);
            imgICon.setImageDrawable(getResources().getDrawable(R.drawable.nsdl));
            subtitle.setText("As per new Regulations, Selling Stocks from your demat Account will require Authorization at NSDL platform with your NSDL TPIN and specifics of Stocks and Quantities you wish to sell \n\n Authorization will be valid for not more then 1 days irrespective if you're selling them now, You can sell the stock from here within 1 days of authorization");
        }else{
            imgICon.setImageDrawable(getResources().getDrawable(R.drawable.cdsl));
            subtitle.setText("As per new Regulations, Selling Stocks from your demat Account will require Authorization at CDSL platform with your CDSL TPIN and specifics of Stocks and Quantities you wish to sell \n\n Authorization will be valid for not more then 90 days irrespective if you're selling them now, You can sell the stock from here within 90 days of authorization");
        }
...
//            Log.e("Greekbase", "Greekbase islast====>>" + islast);
    ...
    private void showAuthorizeTransectionPopup() {
        ...
        if (AccountDetails.getDPType().equalsIgnoreCase("NSDL")){
            prc_to_cdsl.setText("Process to NSDL");
        }
...
//        }
                                ...
                                if (cdslValidation) {
                                    for(int j=0;j<selecteddatalist.size();j++) {
                                        if (Double.parseDouble(selecteddatalist.get(j).getLotSize()) > 1) {
                                            if (Double.parseDouble(selecteddatalist.get(j).getAuthQuantity()) % Double.parseDouble(selecteddatalist.get(j).getLotSize()) != 0) {
                                                GreekDialog.alertDialog(GreekBaseActivity.this, 0, GREEK, "Entered Quantity is not in a multiple of Lot Size (" + selecteddatalist.get(j).getLotSize() + ") For " + selecteddatalist.get(j).getSymbol(), "OK", false, null);
                                                return;
                                            }
                                        }
                                    }
    ...
    private void sendAuthorizationRequestNSDL(ArrayList<AuthTransectionModel.AgeingTransData> selecteddatalist) {
        ...
        try {
            ...
            MarketsSingleScripRequest.sendRequesNSDL(gscid, dPType, reqType, requestIdentifier, RU, BOID, ExID,
                    deviceId, channel,ExID,Segment,jsonArray, GreekBaseActivity.this, serviceResponseHandler);
...
//        String BOID = "1209240000000063";
    ...
    private void showAuthorizeTransectionReturnnResponseNSDL(ArrayList<UpdateNSDLAuthorizationResponse.Response.Data.StockDetail> returnlist) {
        ...
        sell_transection_list.setLayoutManager(linearLayOutExeption);
        sell_transection_list.setHasFixedSize(true);
        final AuthorizeTransStatusAdapterNSDL adapter = new AuthorizeTransStatusAdapterNSDL(GreekBaseActivity.this, returnlist);
        ((SimpleItemAnimator) sell_transection_list.getItemAnimator()).setSupportsChangeAnimations(false);
        sell_transection_list.setAdapter(adapter);
...
//                        holder.dsell_market.requestFocus();
    ...
    public class AuthorizeTransStatusAdapterNSDL extends RecyclerView.Adapter<AuthorizeTransStatusAdapterNSDL.MyViewHolder> {

        Context context;
        ArrayList<UpdateNSDLAuthorizationResponse.Response.Data.StockDetail> authorizeTransDataList;

        public AuthorizeTransStatusAdapterNSDL(Context activity, ArrayList<UpdateNSDLAuthorizationResponse.Response.Data.StockDetail> authorizeTransModels) {
            this.context = activity;
            authorizeTransDataList = authorizeTransModels;
        }

        @Override
        public AuthorizeTransStatusAdapterNSDL.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.authorize_trans_status_data, parent, false);
            return new AuthorizeTransStatusAdapterNSDL.MyViewHolder(itemView);
        }

        @Override
        public void onBindViewHolder(final AuthorizeTransStatusAdapterNSDL.MyViewHolder holder, final int position) {
