...
public class CommodityTopLoserAdapter extends RecyclerView.Adapter<CommodityTopLoserAdapter.MyViewHolder> {
    ArrayList<GainerData> gainerData;
    AppCompatActivity activity;
    private ArrayList tokenList = new ArrayList();

    public CommodityTopLoserAdapter(ArrayList<GainerData> gainerData, AppCompatActivity activity) {
...
//        }
        ...
        if (gainerData1Item.getChange() != null && !gainerData1Item.getChange().equalsIgnoreCase("")) {
            if (gainerData1Item.getPerchange() != null && !gainerData1Item.getPerchange().equalsIgnoreCase("")) {
