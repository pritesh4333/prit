 ...
 * Use the {@link PortfolioReportFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class PortfolioReportFragment extends GreekBaseFragment {
    ...
    public PortfolioReportFragment() {
     ...
     * @return A new instance of fragment PortfolioReportFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static PortfolioReportFragment newInstance(String param1, String param2) {
        PortfolioReportFragment fragment = new PortfolioReportFragment();
...
//        return inflater.inflate(R.layout.fragment_portfolio_report, container, false);

        view = super.onCreateView(inflater, container, savedInstanceState);
        if (AccountDetails.getThemeFlag(getMainActivity()).equalsIgnoreCase("white")) {
            attachLayout(R.layout.fragment_portfolio_report).setBackgroundColor(getResources().getColor(AccountDetails.backgroundColor));
        } else {
            attachLayout(R.layout.fragment_portfolio_report).setBackground(getResources().getDrawable(AccountDetails.backgroundColor));
        }
        ...
        AccountDetails.currentFragment = NAV_TO_PORTFOLIO_REPORT;
...
//        });
    ...
    private void sendReportRequest() {
        ...
        showProgress();
        PortfolioReportRequest.sendRequest(AccountDetails.getUsername(getActivity()), "getPortfolioDetails_Phillip", startDate, endDate, getActivity(), serviceResponseHandler);
    }
    ...
    public void handleResponse(Object response) {
        ...
        try {
            ...
            Gson gson = new Gson();
            PortfolioReportResponse staff = gson.fromJson(String.valueOf(response), PortfolioReportResponse.class);

            ArrayList<PortfolioReportResponse.Response.Data.FinancialData.PorfolioDetailView> orderBookDataArrayList = (ArrayList<PortfolioReportResponse.Response.Data.FinancialData.PorfolioDetailView>) staff.getResponse().getData().getFinancialData().getPorfolioDetailView();
            orderBookDataArrayList.add(0, new PortfolioReportResponse.Response.Data.FinancialData.PorfolioDetailView("",
                    "", "", "",
                    "", "", "",
                    "", "", "",
                    "", ""));
...
//            addEmptyRecord();
    ...
    private void addEmptyRecord() {
        ...
        ArrayList<PortfolioReportResponse.Response.Data.FinancialData.PorfolioDetailView> orderBookDataArrayList = new ArrayList<>();
//        orderBookDataArrayList.add(new PortfolioReportResponse.Response.Data.FinancialData.PorfolioDetailView(
//                "", "", "",
//                "", "", "", "", "", "",
//                "", "", "", "",
//                "", "", "", "", "", "",
//                "", "", "", ""));
        ...
        adaptiveTableLayout.setAdapter(new PortfolioReportFragment.ReportDataTableAdapter(getMainActivity(), orderBookDataArrayList));
    ...
    public class ReportDataTableAdapter extends LinkedAdaptiveTableAdapter<ViewHolderImpl> {
        ...
        private ArrayList<PortfolioReportResponse.Response.Data.FinancialData.PorfolioDetailView> mTableDataSource;
        ...
        public ReportDataTableAdapter(Context context, ArrayList<PortfolioReportResponse.Response.Data.FinancialData.PorfolioDetailView> tableDataSource) {
        ...
        public void setAppList(ArrayList<PortfolioReportResponse.Response.Data.FinancialData.PorfolioDetailView> categoryModel) {
        ...
        public PortfolioReportResponse.Response.Data.FinancialData.PorfolioDetailView getItemScanData(int position) {
        ...
        public ViewHolderImpl onCreateItemViewHolder(@NonNull ViewGroup parent) {
            return new PortfolioReportFragment.ReportDataTableAdapter.TestViewHolder(mLayoutInflater.inflate(R.layout.second_report_item_card, parent, false));
        }

        @NonNull
        @Override
        public ViewHolderImpl onCreateColumnHeaderViewHolder(@NonNull ViewGroup parent) {
            return new PortfolioReportFragment.ReportDataTableAdapter.TestHeaderColumnViewHolder(mLayoutInflater.inflate(R.layout.item_header_column, parent, false));
        }

        @NonNull
        @Override
        public ViewHolderImpl onCreateRowHeaderViewHolder(@NonNull ViewGroup parent) {
            return new PortfolioReportFragment.ReportDataTableAdapter.TestHeaderRowViewHolder(mLayoutInflater.inflate(R.layout.second_report_header_row, parent, false));
        }

        @NonNull
        @Override
        public ViewHolderImpl onCreateLeftTopHeaderViewHolder(@NonNull ViewGroup parent) {
            return new PortfolioReportFragment.ReportDataTableAdapter.TestHeaderLeftTopViewHolder(mLayoutInflater.inflate(R.layout.item_header_left_top, parent, false));
        }

        @Override
        public void onBindViewHolder(@NonNull ViewHolderImpl viewHolder, int row, int column) {
            final PortfolioReportFragment.ReportDataTableAdapter.TestViewHolder vh = (PortfolioReportFragment.ReportDataTableAdapter.TestViewHolder) viewHolder;


            PortfolioReportResponse.Response.Data.FinancialData.PorfolioDetailView itemData = mTableDataSource.get(row); // skip headers
//            vh.dataSubtitle.setVisibility(View.GONE);

            if (column == 1) {
                if (itemData.getSector() != null && !itemData.getSector().isEmpty()) {
                    vh.dataTitle.setText(itemData.getSector().trim());
                    vh.dataTitle.setGravity(Gravity.CENTER);
                    vh.dataSubtitle.setText(itemData.getSegment().trim());
                ...
                if (itemData.getInvestedAmt() != null && !itemData.getInvestedAmt().isEmpty()) {
                    vh.dataTitle.setText(String.format("%.2f", Double.parseDouble(itemData.getInvestedAmt())).trim());
                    vh.dataTitle.setGravity(Gravity.RIGHT);
                    vh.dataSubtitle.setText(String.format("%.2f", Double.parseDouble(itemData.getCurrentValue())).trim());
                ...
                if (itemData.getUnRelised() != null && !itemData.getUnRelised().isEmpty()) {
                    vh.dataTitle.setText(String.format("%.2f", Double.parseDouble(itemData.getUnRelised())).trim());
                    vh.dataTitle.setGravity(Gravity.RIGHT);
                    vh.dataSubtitle.setText(String.format("%.0f", Double.parseDouble(itemData.getHoldQty())).trim());
                    vh.dataSubtitle.setGravity(Gravity.RIGHT);
                ...
                if (itemData.getBuyPrice() != null && !itemData.getBuyPrice().isEmpty()) {
                    vh.dataTitle.setGravity(Gravity.RIGHT);
                    vh.dataTitle.setText(String.format("%.2f", Double.parseDouble(itemData.getBuyPrice())).trim());
                    vh.dataSubtitle.setText(String.format("%.2f", Double.parseDouble(itemData.getCurrentPrice())).trim());
                    vh.dataSubtitle.setGravity(Gravity.RIGHT);
        ...
        public void onBindHeaderColumnViewHolder(@NonNull ViewHolderImpl viewHolder, final int column) {
            PortfolioReportFragment.ReportDataTableAdapter.TestHeaderColumnViewHolder vh = (PortfolioReportFragment.ReportDataTableAdapter.TestHeaderColumnViewHolder) viewHolder;

//            vh.headerColumnSubtitle.setVisibility(View.GONE);

            if (column == 1) {
                vh.headerColumnTitle.setText("Sector");
                vh.headerColumnTitle.setGravity(Gravity.CENTER);
                  vh.headerColumnSubtitle.setText("Segment");
                vh.headerColumnSubtitle.setGravity(Gravity.CENTER);
            } else if (column == 2) {
                vh.headerColumnTitle.setText("Invested Amt");
                vh.headerColumnTitle.setGravity(Gravity.RIGHT);
                vh.headerColumnSubtitle.setText("Current Value");
                vh.headerColumnSubtitle.setGravity(Gravity.RIGHT);
            } else if (column == 3) {
                vh.headerColumnTitle.setText("Unrealised");
                vh.headerColumnTitle.setGravity(Gravity.RIGHT);
                vh.headerColumnSubtitle.setText("Holding Qty");
                vh.headerColumnSubtitle.setGravity(Gravity.RIGHT);
            } else if (column == 4) {
                vh.headerColumnTitle.setText("Holding Price");
                vh.headerColumnTitle.setGravity(Gravity.RIGHT);
                vh.headerColumnSubtitle.setText("Current Price");
                vh.headerColumnSubtitle.setGravity(Gravity.RIGHT);
            }
        ...
        public void onBindHeaderRowViewHolder(@NonNull ViewHolderImpl viewHolder, int row) {
            ...
            PortfolioReportFragment.ReportDataTableAdapter.TestHeaderRowViewHolder vh = (PortfolioReportFragment.ReportDataTableAdapter.TestHeaderRowViewHolder) viewHolder;
            vh.headerRowSubtitle.setVisibility(View.GONE);

            if (mTableDataSource.get(row).getScrip() != null && !mTableDataSource.get(row).getScrip().isEmpty()) {
                vh.headerRowTitle.setText(mTableDataSource.get(row).getScrip());
        ...
        public void onBindLeftTopHeaderViewHolder(@NonNull ViewHolderImpl viewHolder) {
            PortfolioReportFragment.ReportDataTableAdapter.TestHeaderLeftTopViewHolder vh = (PortfolioReportFragment.ReportDataTableAdapter.TestHeaderLeftTopViewHolder) viewHolder;
...
//                    viewLine2.setBackgroundColor(getResources().getColor(R.color.white));
        ...
        private class TestHeaderColumnViewHolder extends ViewHolderImpl {
            ...
            private TestHeaderColumnViewHolder(@NonNull View itemView) {
                ...
                vLine = itemView.findViewById(R.id.vLine);
                viewLine3 = itemView.findViewById(R.id.viewLine2);
                ...
                if (AccountDetails.getThemeFlag(ctx).equalsIgnoreCase("white")) {
                   // vLine.setBackgroundColor(getResources().getColor(AccountDetails.textColorDropdown));
...
//            edt_from.setBackgroundTintList(getActivity().getResources().getColorStateList(R.color.gray_border));
//            edt_to.setBackgroundTintList(getActivity().getResources().getColorStateList(R.color.gray_border));
