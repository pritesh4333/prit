...
public class ChartSymbolAutoCompleteAdapter extends BaseAdapter implements Filterable {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (assetType.equals("Equity")||assetType.equals("All")) {
...
//                            url = "getSymbolLookup_Bajaj_Mobile?assetType=" + URLEncoder.encode(assetType, "utf-8").toLowerCase() + "&code=" + URLEncoder.encode((constraint.toString()));
                        } else {
...
//                            url = "getSymbolLookup_Bajaj_Mobile?assetType=" + URLEncoder.encode("option", "utf-8").toLowerCase() + "&code=" + URLEncoder.encode((constraint.toString()));
                        }
