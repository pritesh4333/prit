...
import com.acumengroup.mobile.ChatMessage.ChatAppMsgViewHolder;
...
public class NotificationListAdapter extends RecyclerView.Adapter<ChatAppMsgViewHolder> {

    private List<ChatAppMsgDTO> msgDtoList = null;

    public NotificationListAdapter(List<ChatAppMsgDTO> msgDtoList) {
    ...
    public ChatAppMsgViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = layoutInflater.inflate(R.layout.fragment_notification_row, parent, false);
