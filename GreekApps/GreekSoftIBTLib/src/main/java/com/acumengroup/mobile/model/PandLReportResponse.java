...
public class PandLReportResponse implements GreekRequestModel, GreekResponseModel {
    private List<PLData> arrayList = new ArrayList();


    public List<PLData> getSaudaResponse() {
        return arrayList;
    }

    public void setSaudaResponse(List<PLData> saudaResponse) {
        ...
        if(jo.optJSONArray("data") !=null) {
            ...
            for (int i = 0; i < ja1.length(); i++) {
                ...
                if ((o instanceof JSONObject)) {
                    PLData data = new PLData();
                    data.fromJSON((JSONObject) o);
                    this.arrayList.add(data);
                } else {
                    this.arrayList.add((PLData) o);
                }
            }
        }
