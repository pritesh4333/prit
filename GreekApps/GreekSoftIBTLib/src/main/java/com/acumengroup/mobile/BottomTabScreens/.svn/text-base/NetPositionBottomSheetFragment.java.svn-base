...
public class NetPositionBottomSheetFragment extends BottomSheetDialogFragment {
    ...
    private GreekTextView symbolnametxt, exchangetxt, ltptxt, buyQtytxt, sellQtytxt, buyAmttxt, buyPricetxt, sellPricetxt, sellAmttxt, unrealizedgltxt, realizedgl, totalgltxt, producttypetxt, mtmtxt, ltp_txt_1;
    ...
    private void setupView() {
        ...
        ltp_txt_1 = orderDetailsView.findViewById(R.id.ltp_txt_1);
    ...
    private void setTheme() {
        ...
        if (AccountDetails.getThemeFlag(getActivity()).equalsIgnoreCase("white")) {
            ...
            ltp_txt_1.setTextColor(getResources().getColor(AccountDetails.textColorDropdown));
