...
public class CurrencyTopLoserAdapter extends RecyclerView.Adapter<CurrencyTopLoserAdapter.MyViewHolder> {
    ArrayList<GainerData> gainerData;
    AppCompatActivity activity;
    private ArrayList tokenList = new ArrayList();

    public CurrencyTopLoserAdapter(ArrayList<GainerData> gainerData, AppCompatActivity activity) {
