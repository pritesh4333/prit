...
public class PandLReportdetailsRequest implements GreekRequestModel, GreekResponseModel {
    ...
    public static void sendRequest(JSONObject request, String ServiceName, Context ctx, ServiceResponseListener listener) {
        ...
        jsonRequest.setService("getProfitAndLossDetails_Phillip", ServiceName);
