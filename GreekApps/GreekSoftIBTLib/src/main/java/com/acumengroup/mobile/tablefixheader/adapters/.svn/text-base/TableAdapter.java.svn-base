...
public interface TableAdapter {
	 ...
	 */
	void registerDataSetObserver(CustomDataSetObserver observer);
	 ...
	 */
	void unregisterDataSetObserver(CustomDataSetObserver observer);

	/**
	 * How many rows are in the data watch_table represented by this Adapter.
	 * 
	...
	/**
	 * How many columns are in the data watch_table represented by this Adapter.
	 * 
	 ...
	 * data watch_table. You can either create a View manually or inflate it from an
	 * XML layout file.
	 * 
	 * @param row
	 *            The row of the item within the adapter's data watch_table of the
	 *            item whose view we want. If the row is <code>-1</code> it is
	 *            the header.
	 * @param column
	 *            The column of the item within the adapter's data watch_table of the
