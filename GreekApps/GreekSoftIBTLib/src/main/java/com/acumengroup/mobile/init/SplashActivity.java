package com.acumengroup.mobile.init;
...
public class SplashActivity extends AppCompatActivity implements GreekUIServiceHandler, GreekConstants {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (appname.equalsIgnoreCase("Vishwas")){
            setContentView(R.layout.vishwas_splash_screen);
        }else if(appname.equalsIgnoreCase("Trade On Go")){
            setContentView(R.layout.philips_splash_screen);
            ...
            setContentView(R.layout.cliqtrade_splash_screen);
        }else{
            setContentView(R.layout.marwadi_splash_screen);
        }
       ...
       /* else if(Util.getPrefs(this).getInt("NotificationVal", 0) == 1012)
        ...
        if (Build.VERSION.SDK_INT > Build.VERSION_CODES.KITKAT) {
            ...
            GreekDialog.alertDialog(SplashActivity.this, 0, alert_title, "Application is not supported", "Ok", false, new DialogListener() {
    ...
    private void checkNetwork() {
        ...
        if (GreekStatistics.isNetworkEnabled(this)) {
         ...
         /* int updatecancelval =   Util.getPrefs(this).getInt("UpdateCancel", 0);
            ...
            if (count < 2) {
                count++;
                GreekDialog.alertDialog(SplashActivity.this, 0, alert_title, "Application needs network to proceed", "Retrieve", "Exit", false, new DialogListener() {
                ...
                GreekDialog.alertDialog(SplashActivity.this, 0, alert_title, "Application needs network to proceed", "Exit", false, new DialogListener() {
...
//                        } else {
    ...
    public void handleError(int errorCode, final String message, Object error, ServiceRequest serviceRequest) {
        ...
        GreekDialog.alertDialog(SplashActivity.this, 0, alert_title, message, "Retry", "Exit", false, new DialogListener() {
    ...
    public void infoDialog(int action, final String msg, JSONResponse jsonResponse) {
        if (action == ActionCode.ACT_CODE_OK.value) {
            GreekDialog.alertDialog(this, 0, alert_title, msg, "OK", true, new DialogListener() {
                @Override
                public void alertDialogAction(Action action, Object... data) {
                ...
                if (!updateVersion.equalsIgnoreCase(onlineVersion)) {
                    if (value == 1) {
                        ...
                        if (updatecancelval == 0) {
                            ...
                            GreekDialog.alertDialog(SplashActivity.this, 0, alert_title, "New Update is available on playstore", "Update", "Cancel", false, new DialogListener() {
