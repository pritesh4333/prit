...
//        intent.putExtra("isProceedFrom", NAV_TO_NOTIFICATION_SCREEN);
        ...
        else if (appname.equalsIgnoreCase("Trade On Go"))
        {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
                ...
                builder = new NotificationCompat.Builder(getApplicationContext(), id);
                builder.setAutoCancel(true)
                        .setSmallIcon(R.mipmap.mandot_login_icon)
                        .setLargeIcon(drawableToBitmap(getResources().getDrawable(R.mipmap.mandot_login_icon)))
                        .setStyle(bigTextStyle)
                        .setAutoCancel(true)
                        .setGroup(GROUP_KEY_MESSAGES)
                        .setGroupSummary(true)
                        .setContentTitle("Mandot")
                        .setChannelId(id)
                        .setVibrate(v)
                        .setSound(uri)
                        .setNumber(count)
                ...
                builder = new NotificationCompat.Builder(this, id)
                        .setAutoCancel(true)
                        .setSmallIcon(R.drawable.mandot_login_icon)
                        .setLargeIcon(drawableToBitmap(getResources().getDrawable(R.mipmap.mandot_login_icon)))
                        .setStyle(bigTextStyle)
                        .setAutoCancel(true)
                        .setGroup(GROUP_KEY_MESSAGES)
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
                ...
                builder = new NotificationCompat.Builder(getApplicationContext(), id);
                builder.setAutoCancel(true)
                        .setSmallIcon(R.drawable.cliqtrade_icon)
                        .setLargeIcon(drawableToBitmap(getResources().getDrawable(R.mipmap.cliqtrade_icon)))
                        .setStyle(bigTextStyle)
                        .setAutoCancel(true)
                        .setGroup(GROUP_KEY_MESSAGES)
                        .setGroupSummary(true)
                        .setContentTitle("Cliqtrade")
                        .setChannelId(id)
                        .setVibrate(v)
                        .setSound(uri)
                        .setNumber(count)
