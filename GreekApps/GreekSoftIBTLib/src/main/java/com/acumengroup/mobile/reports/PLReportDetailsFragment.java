...
import com.acumengroup.mobile.model.PandLReportDetailsModel.PandLReportDetailsResponse;
import com.acumengroup.mobile.model.PandLReportDetailsModel.PandLReportdetailsRequest;
...
public class PLReportDetailsFragment extends GreekBaseFragment {
    ...
    public PLReportDetailsFragment() {
        // Required empty public constructor
    }

    public static PLReportDetailsFragment newInstance(String param1, String param2) {
        PLReportDetailsFragment fragment = new PLReportDetailsFragment();
...
//        return inflater.inflate(R.layout.fragment_p_l_report_details, container, false);
        view = super.onCreateView(inflater, container, savedInstanceState);
        if (AccountDetails.getThemeFlag(getMainActivity()).equalsIgnoreCase("white")) {
            attachLayout(R.layout.fragment_p_l_report_details).setBackgroundColor(getResources().getColor(AccountDetails.backgroundColor));
        } else {
            attachLayout(R.layout.fragment_p_l_report_details).setBackground(getResources().getDrawable(AccountDetails.backgroundColor));
        }
        ...
        AccountDetails.currentFragment = NAV_TO_P_AND_L_DETAIL_REPORT;
...
//        });
    ...
    private void sendReportRequest() {
        ...
        showProgress();
        PandLReportdetailsRequest.sendRequest(AccountDetails.getUsername(getActivity()), "getProfitAndLossDetails_Phillip", startDate, endDate, getActivity(), serviceResponseHandler);
    }
    ...
    public void handleResponse(Object response) {
        ...
        try {
            ...
            Gson gson = new Gson();
            PandLReportDetailsResponse staff = gson.fromJson(String.valueOf(response), PandLReportDetailsResponse.class);

            ArrayList<PandLReportDetailsResponse.Response.Data.FinancialData.PnlDetails> orderBookDataArrayList = (ArrayList<PandLReportDetailsResponse.Response.Data.FinancialData.PnlDetails>) staff.getResponse().getData().getFinancialData().getPnlDetail();
            orderBookDataArrayList.add(0, new PandLReportDetailsResponse.Response.Data.FinancialData.PnlDetails("",
                    "", "", "",
                    "", "", "",
                    "", "", "",
                    "", ""));
...
//            addEmptyRecord();
    ...
    private void addEmptyRecord() {
        ...
        ArrayList<PandLReportDetailsResponse.Response.Data.FinancialData.PnlDetails> orderBookDataArrayList = new ArrayList<>();
//        orderBookDataArrayList.add(new PandLReportDetailsResponse.Response.Data.FinancialData.PnlDetails(
//                "", "", "",
//                "", "", "", "", "", "",
//                "", "", "", "",
//                "", "", "", "", "", "",
//                "", "", "", ""));
        ...
        adaptiveTableLayout.setAdapter(new PLReportDetailsFragment.ReportDataTableAdapter(getMainActivity(), orderBookDataArrayList));
    ...
    public class ReportDataTableAdapter extends LinkedAdaptiveTableAdapter<ViewHolderImpl> {
        ...
        private ArrayList<PandLReportDetailsResponse.Response.Data.FinancialData.PnlDetails> mTableDataSource;
        ...
        public ReportDataTableAdapter(Context context, ArrayList<PandLReportDetailsResponse.Response.Data.FinancialData.PnlDetails> tableDataSource) {
        ...
        public void setAppList(ArrayList<PandLReportDetailsResponse.Response.Data.FinancialData.PnlDetails> categoryModel) {
        ...
        public PandLReportDetailsResponse.Response.Data.FinancialData.PnlDetails getItemScanData(int position) {
        ...
        public ViewHolderImpl onCreateItemViewHolder(@NonNull ViewGroup parent) {
            return new PLReportDetailsFragment.ReportDataTableAdapter.TestViewHolder(mLayoutInflater.inflate(R.layout.second_report_item_card, parent, false));
        }

        @NonNull
        @Override
        public ViewHolderImpl onCreateColumnHeaderViewHolder(@NonNull ViewGroup parent) {
            return new PLReportDetailsFragment.ReportDataTableAdapter.TestHeaderColumnViewHolder(mLayoutInflater.inflate(R.layout.item_header_column, parent, false));
        }

        @NonNull
        @Override
        public ViewHolderImpl onCreateRowHeaderViewHolder(@NonNull ViewGroup parent) {
            return new PLReportDetailsFragment.ReportDataTableAdapter.TestHeaderRowViewHolder(mLayoutInflater.inflate(R.layout.second_report_header_row, parent, false));
        }

        @NonNull
        @Override
        public ViewHolderImpl onCreateLeftTopHeaderViewHolder(@NonNull ViewGroup parent) {
            return new PLReportDetailsFragment.ReportDataTableAdapter.TestHeaderLeftTopViewHolder(mLayoutInflater.inflate(R.layout.item_header_left_top, parent, false));
        }

        @Override
        public void onBindViewHolder(@NonNull ViewHolderImpl viewHolder, int row, int column) {
            final PLReportDetailsFragment.ReportDataTableAdapter.TestViewHolder vh = (PLReportDetailsFragment.ReportDataTableAdapter.TestViewHolder) viewHolder;


            PandLReportDetailsResponse.Response.Data.FinancialData.PnlDetails itemData = mTableDataSource.get(row); // skip headers
//            vh.dataSubtitle.setVisibility(View.GONE);


            if (column == 1) {
                if (itemData.getBuyDate() != null && !itemData.getBuyDate().isEmpty()) {
                    vh.dataTitle.setText(itemData.getBuyDate().trim());
                    vh.dataTitle.setGravity(Gravity.CENTER);
                    vh.dataSubtitle.setText(itemData.getSellDate().trim());
                ...
                if (itemData.getBuyQty() != null && !itemData.getBuyQty().isEmpty()) {
                    vh.dataTitle.setText(itemData.getBuyQty().trim());
                    vh.dataTitle.setGravity(Gravity.RIGHT);
                    vh.dataSubtitle.setText(itemData.getSellQty().trim());
                ...
                if (itemData.getBuyRate() != null && !itemData.getBuyRate().isEmpty()) {
                    vh.dataTitle.setText(String.format("%.2f", Double.parseDouble(itemData.getBuyRate())).trim());
                    vh.dataTitle.setGravity(Gravity.RIGHT);
                    vh.dataSubtitle.setText(String.format("%.2f", Double.parseDouble(itemData.getSellRate())).trim());
                    vh.dataSubtitle.setGravity(Gravity.RIGHT);
                ...
                if (itemData.getClRate() != null && !itemData.getClRate().isEmpty()) {
                    vh.dataTitle.setGravity(Gravity.RIGHT);
                    vh.dataTitle.setText(String.format("%.2f", Double.parseDouble(itemData.getClRate())).trim());
                    vh.dataSubtitle.setText(String.format("%.2f", Double.parseDouble(itemData.getPnlAmount())).trim());
                    vh.dataSubtitle.setGravity(Gravity.RIGHT);
        ...
        public void onBindHeaderColumnViewHolder(@NonNull ViewHolderImpl viewHolder, final int column) {
            PLReportDetailsFragment.ReportDataTableAdapter.TestHeaderColumnViewHolder vh = (PLReportDetailsFragment.ReportDataTableAdapter.TestHeaderColumnViewHolder) viewHolder;

//            vh.headerColumnSubtitle.setVisibility(View.GONE);

            if (column == 1) {
                vh.headerColumnTitle.setText("Buy Date");
                vh.headerColumnTitle.setGravity(Gravity.CENTER);
                vh.headerColumnSubtitle.setText("sell Date");
                vh.headerColumnSubtitle.setGravity(Gravity.CENTER);
            } else if (column == 2) {
                vh.headerColumnTitle.setText("Buy Qty");
                ...
                vh.headerColumnTitle.setText("Buy Rate");
                vh.headerColumnTitle.setGravity(Gravity.RIGHT);
                vh.headerColumnSubtitle.setText("Sell Rate");
                vh.headerColumnSubtitle.setGravity(Gravity.RIGHT);
            } else if (column == 4) {
                vh.headerColumnTitle.setText("Close Rate");
                vh.headerColumnTitle.setGravity(Gravity.RIGHT);
                vh.headerColumnSubtitle.setText("PnL Amount");
                vh.headerColumnSubtitle.setGravity(Gravity.RIGHT);
            }
        ...
        public void onBindHeaderRowViewHolder(@NonNull ViewHolderImpl viewHolder, int row) {
            ...
            PLReportDetailsFragment.ReportDataTableAdapter.TestHeaderRowViewHolder vh = (PLReportDetailsFragment.ReportDataTableAdapter.TestHeaderRowViewHolder) viewHolder;
        ...
        public void onBindLeftTopHeaderViewHolder(@NonNull ViewHolderImpl viewHolder) {
            PLReportDetailsFragment.ReportDataTableAdapter.TestHeaderLeftTopViewHolder vh = (PLReportDetailsFragment.ReportDataTableAdapter.TestHeaderLeftTopViewHolder) viewHolder;
