...
import com.acumengroup.mobile.reports.FinancialStatementFragment;
...
import com.acumengroup.mobile.reports.PLReportDetailsFragment;
import com.acumengroup.mobile.reports.PortfolioReportFragment;
...
import com.acumengroup.mobile.reports.TransactionReportFragment;
...
public class MenuGetter implements GreekConstants {
    ...
    public static Fragment getFragment(String menuCode) {
        ...
        switch (menuCode) {
            ...
            case GREEK_MENU_PORTFOLIO_REPORT:
                if (USER_TYPE == USER.CUSTOMER || USER_TYPE == USER.IBTCUSTOMER)
                    frag = new PortfolioReportFragment();
                break;
            case GREEK_MENU_TRANSACTION_REPORT:
                if (USER_TYPE == USER.CUSTOMER || USER_TYPE == USER.IBTCUSTOMER)
                    frag = new TransactionReportFragment();
                break;
            case GREEK_MENU_P_L_REPORT_DETAILS:
                if (USER_TYPE == USER.CUSTOMER || USER_TYPE == USER.IBTCUSTOMER)
                    frag = new PLReportDetailsFragment();
                break;
            case GREEK_MENU_FINANCIAL_STATEMENT:
                if (USER_TYPE == USER.CUSTOMER || USER_TYPE == USER.IBTCUSTOMER)
                    frag = new FinancialStatementFragment();
                break;
