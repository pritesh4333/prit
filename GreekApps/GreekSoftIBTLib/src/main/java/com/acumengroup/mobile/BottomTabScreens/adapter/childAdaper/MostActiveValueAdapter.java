...
public class MostActiveValueAdapter extends RecyclerView.Adapter<MostActiveValueAdapter.MyViewHolder> {
    List<GainerData_v2> gainerData;
    AppCompatActivity activity;
    private ArrayList tokenArrayList = new ArrayList();

    public MostActiveValueAdapter(List<GainerData_v2> gainerData, AppCompatActivity activity) {
