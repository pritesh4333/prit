...
public class WebContentPledgeCDSL extends AppCompatActivity {
...
//        TransDtls="";
        ...
        String html = "<html>" +
                "<head></head>" +
                "<body onload='document.frmpledge.submit()'>" +
                "<form name='frmpledge' method = 'post' action= '"+Url+"'>" +
                "<input type='hidden' name= 'dpid' value= '" + DPId + "'/>" +
                "<input type='hidden' name= 'reqid' value= '" + ReqId + "'/>" +
                "<input type='hidden' name= 'version' value= '" + Version + "'/>" +
                "<input type='hidden' name= 'pledgedtls' value= '" + TransDtls + "'/>" +
                "</form>" +
                "</body>" +
                "</html>";
