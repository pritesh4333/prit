...
public class TopLoserAdapter extends RecyclerView.Adapter<TopLoserAdapter.MyViewHolder> {
    ArrayList<GainerData_v2> gainerData;
    AppCompatActivity activity;
    private ArrayList tokenList = new ArrayList();

    public TopLoserAdapter(ArrayList<GainerData_v2> gainerData, AppCompatActivity activity) {
