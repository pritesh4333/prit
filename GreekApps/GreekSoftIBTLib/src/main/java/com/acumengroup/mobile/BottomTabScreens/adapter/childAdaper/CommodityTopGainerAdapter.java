...
public class CommodityTopGainerAdapter extends RecyclerView.Adapter<CommodityTopGainerAdapter.MyViewHolder> {
    ArrayList<GainerData> gainerData;
    AppCompatActivity activity;
    private ArrayList tokenList = new ArrayList();

    public CommodityTopGainerAdapter(ArrayList<GainerData> gainerData, AppCompatActivity activity) {
    ...
    @Override
    public void onBindViewHolder(CommodityTopGainerAdapter.MyViewHolder holder, int position) {
...
//            }
            ...
            if (gainerData1Item.getChange() != null && !gainerData1Item.getChange().equalsIgnoreCase("") && !gainerData1Item.getPerchange().equalsIgnoreCase("")) {
                ...
                if (gainerData1Item.getAssetType().equalsIgnoreCase("currency")) {
                    ...
                    holder.changeTxt.setText(StringStuff.commaDecorator(String.format("%.2f", Double.parseDouble(gainerData1Item.getChange()))) +
