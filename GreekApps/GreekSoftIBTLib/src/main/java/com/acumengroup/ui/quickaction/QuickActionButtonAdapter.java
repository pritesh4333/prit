...
public class QuickActionButtonAdapter extends BaseAdapter {

    private Context mContext;
    private Vector<QuickActionItemDetails> items;
    private int resourceId = 0;
    private int selectedPosition = -1;
    private int enableTextColor = Color.WHITE;
    ...
    public QuickActionButtonAdapter(Context context, Vector<QuickActionItemDetails> items/* , int imageRes */) {
