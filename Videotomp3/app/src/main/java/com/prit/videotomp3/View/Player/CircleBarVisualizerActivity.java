...
import com.prit.videotomp3.View.MyFiles.Mp3FileAdapter;

import java.io.File;
import java.util.Random;
import java.util.concurrent.TimeUnit;

import static com.prit.videotomp3.View.Player.BaseActivity.AUDIO_PERMISSION_REQUEST_CODE;
import static com.prit.videotomp3.View.Player.BaseActivity.WRITE_EXTERNAL_STORAGE_PERMS;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editfilename.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                AdLoader adLoader = new AdLoader.Builder(CircleBarVisualizerActivity.this, natice_advanceadd)
