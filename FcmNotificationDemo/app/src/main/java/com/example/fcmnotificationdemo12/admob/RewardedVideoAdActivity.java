package com.example.fcmnotificationdemo12.admob;
...
public class RewardedVideoAdActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRewardedVideoAd.setRewardedVideoAdListener(new RewardedVideoAdListener() {
            ...
            public void onRewardedVideoCompleted() {
                Toast.makeText(RewardedVideoAdActivity.this, "Video complete", Toast.LENGTH_SHORT).show();
            }
    ...
    private void loadRewardedVideoAd() {
        mRewardedVideoAd.loadAd(getString(R.string.testidforrewarded_video),
