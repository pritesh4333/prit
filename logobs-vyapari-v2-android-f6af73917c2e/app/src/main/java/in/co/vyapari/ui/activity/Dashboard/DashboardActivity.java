        ...
        if (DashboardData != null) {
            if (DashboardData.get(0).getValue() != null) {
                if (DashboardData.get(0).getValue().contains("-")) {
                    ...
                    Bank.setText("₹" + indianCurrency(Double.valueOf(DashboardData.get(0).getValue().substring(1))));
                }
                else {
                    Bank.setText("₹" + indianCurrency(Double.valueOf(DashboardData.get(0).getValue())));
                }
            } else {
                Bank.setText("₹0.00");
            }
            if (DashboardData.get(1).getValue() != null) {
                if (DashboardData.get(1).getValue().contains("-")) {
                    cash.setText("₹" + indianCurrency(Double.valueOf(DashboardData.get(1).getValue().substring(1))));
                }else{
                    cash.setText("₹" + indianCurrency(Double.valueOf(DashboardData.get(1).getValue())));
                }
            } else {
                cash.setText("₹0.00");
            }
            if (DashboardData.get(2).getValue() != null) {
                if (DashboardData.get(2).getValue().contains("-")) {
                    Collection.setText("₹" + indianCurrency(Double.valueOf(DashboardData.get(2).getValue().substring(1))));
                }else{
                    Collection.setText("₹"+ indianCurrency(Double.valueOf(DashboardData.get(2).getValue())));
                }
            } else {
                Collection.setText("₹0.00");
            }
            if (DashboardData.get(3).getValue() != null) {
                if (DashboardData.get(3).getValue().contains("-")) {
                    Payment.setText("₹" + indianCurrency(Double.valueOf(DashboardData.get(3).getValue().substring(1))));
                }else{
                    Payment.setText("₹" + indianCurrency(Double.valueOf(DashboardData.get(3).getValue())));
                }
            } else {
