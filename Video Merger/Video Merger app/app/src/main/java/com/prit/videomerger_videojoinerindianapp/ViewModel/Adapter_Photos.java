...
import com.prit.videomerger_videojoinerindianapp.Model.Model_images;
...
public class Adapter_Photos extends ArrayAdapter<Model_images> {
    ...
    public Adapter_Photos(Context context, ArrayList<Model_images> al_menu) {
    ...
    public int getCount() {
        ...
        Helper.LogPrint("ADAPTER LIST SIZE", al_menu.size() + "");
        return al_menu.size();
    }
