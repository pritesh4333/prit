...
public class CreateProductActivity extends SohoActivity {
    ...
    public void saveProductClick() {
        ...
        if(selectedHSNSACCode==null){
            Toasty.error(mContext,getResources().getString(R.string.select_HSN_CODE)).show();
        }
        else if (GSTCode.getValue().equalsIgnoreCase("Please select..")){
            Toasty.error(mContext,getResources().getString(R.string.select_GST_CODE)).show();
        }
        else if (unit.getValue().equalsIgnoreCase("Please select..")){
            Toasty.error(mContext,getResources().getString(R.string.select_Unit_CODE)).show();
        }else{
