...
public class PurchaseReceiptDetailActivity extends SohoActivity {
...
//        }
    ...
    private void setInvoiceLineArea() {
        ...
        Total_amount.setText(getResources().getString(R.string.ReceiptAmount));
...
//        warehouseTV.setText(invoice.getWarehouse().getValue());
    ...
    public void editInvoice() {
        if (!isApproved) {
            ...
            String message = getString(R.string.edit_purchase_receipt_change_status_msg);
            Utils.generateDialog(mContext, getString(R.string.edit_Purchase_receipt), message,
    ...
    private void openEditInvoice() {
        ...
        startActivity(new Intent(mContext, CreatePurchaseReceiptActivity.class));
        finish();
    }
