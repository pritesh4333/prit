...
public class SalesOrderDetailActivity extends SohoActivity {
    ...
    ImageView iconUp;
    @BindView(R.id. invoice_detail_showDatePickerDialogPaymentDate)
    LinearLayout invoice_detail_showDatePickerDialogPaymentDate;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        invoice_detail_showDatePickerDialogPaymentDate.setVisibility(View.VISIBLE);
...
//        warehouseTV.setText(invoice.getWarehouse().getValue());
    ...
    public void editInvoice() {
        if (!isApproved) {
            ...
            String message = getString(R.string.edit_sale_order_status_msg);
            Utils.generateDialog(mContext, getString(R.string.edit_Sales_order), message,
    ...
    private void openEditInvoice() {
        ...
        startActivity(new Intent(mContext, CreateSalesOrderActivity.class));
        finish();
    }
