...
public interface ServiceRequest {
    ...
    @GET("/api/Common/POS")
    Call<BaseModel<List<POS>>> getInvoicePOS();
    ...
    @POST("/api/Product/ProductSlip")
    Call<BaseModel<ProductSlip>> createproductSlip(@Query("slipType") int i,@Body ProductSlip productslip);
    ...
    Call<BaseModel<Boolean>> changeStatus(@Query("id") String id, @Query("invoiceType") int invoiceType, @Query("StatusType") int StatusType);
    // Invoice


    //Order
    @GET("/api/Common/OrderSlipNumber")
    Call<BaseModel<String>> getOrderinvoiceNumber(@Query("SlipType") int SlipType);

    @GET("/api/Order/getByType")
    Call<BaseModel<InvoiceDTO>> getOrderDetail(@Query("id") String id, @Query("invoiceType") int invoiceType);

    @POST("/api/Order/calculateOrder")
    Call<BaseModel<InvoiceDTO>> calculateOrder(@Body Invoice invoice);

    @GET("/api/Order/getByType")
    Call<BaseModel<Invoice>> getOrderDetailEdit(@Query("id") String id, @Query("invoiceType") int invoiceType);

    @POST("/api/Order/billing")
    Call<BaseModel<InvoiceDTO>> addOrderToInvoice(@Body Invoice invoice);

    @POST("/api/Order/search")
    Call<BaseModel<InvoicesSumDTO>> getOrders(@Body Filter filter);

    @DELETE("/api/Order/deleteByType")
    Call<BaseModel<InvoiceDTO>> deleteOrder(@Query("id") String id , @Query("orderType") int invoiceType);

    @POST("/api/Order")
    Call<BaseModel<InvoiceDTO>> addOrder(@Body Invoice invoice);

    @PUT("/api/Order")
    Call<BaseModel<InvoiceDTO>> updateOrder(@Body Invoice invoice);

    @GET("/api/Order/changeStatus")
    Call<BaseModel<Boolean>> OrderchangeStatus(@Query("id") String id, @Query("invoiceType") int invoiceType, @Query("StatusType") int StatusType);

    //Dispatch
    @GET("/api/Common/DispatchSlipNumber")
    Call<BaseModel<String>> getDispatchinvoiceNumber(@Query("SlipType") int SlipType);

    @POST("/api/Dispatch/search")
    Call<BaseModel<InvoicesSumDTO>> getDispatch(@Body Filter filter);

    @POST("/api/Dispatch/calculateDispatch")
    Call<BaseModel<InvoiceDTO>> calculateDispatch(@Body Invoice invoice);

    @GET("/api/Dispatch/getByType")
    Call<BaseModel<InvoiceDTO>> getDispatchDetail(@Query("id") String id, @Query("invoiceType") int invoiceType);

    @GET("/api/Dispatch/getByType")
    Call<BaseModel<Invoice>> getDispatchDetailEdit(@Query("id") String id, @Query("invoiceType") int invoiceType);

    @POST("/api/Dispatch")
    Call<BaseModel<InvoiceDTO>> addDispatch(@Body Invoice invoice);

    @DELETE("/api/Dispatch/{id}")
    Call<BaseModel<InvoiceDTO>> deleteDispatch(@Path("id") String id);

    @PUT("/api/Dispatch")
    Call<BaseModel<InvoiceDTO>> updateDispatch(@Body Invoice invoice);

    @GET("/api/Dispatch/changeStatus")
    Call<BaseModel<Boolean>> DispatchhangeStatus(@Query("id") String id, @Query("invoiceType") int invoiceType, @Query("StatusType") int StatusType);
}