...
public class PurchaseReturnDetailActivity extends SohoActivity {
...
//        }
    ...
    private void setInvoiceLineArea() {
        ...
        Total_amount.setText(getResources().getString(R.string.ReturnAmount));
...
//        warehouseTV.setText(invoice.getWarehouse().getValue());
    ...
    private void setInvoiceDeliveryDate() {
        if (invoice.getDeliveryDate() != null) {
            ...
            String invoicePaymentDayMonth = cm.getDay() + " " + cm.getMonthName()+" "+cm.getYear();
            //invoice_Detail_pos.setText(invoicePaymentDayMonth);
    ...
    public void editInvoice() {
        if (!isApproved) {
            ...
            String message = getString(R.string.edit_purchase_return_change_status_msg);
            Utils.generateDialog(mContext, getString(R.string.edit_Purchase_return), message,
    ...
    private void openEditInvoice() {
        ...
        startActivity(new Intent(mContext, CreatePurchaseReturnActivity.class));
        finish();
    }

//    private void changeStatusCall(final boolean goToEdit) {
//        InvoiceService.changeStatus(invoice.getId(), 5, StatusType, new ServiceCall<BaseModel<Boolean>>() {
//            @Override
//            public void start() {
