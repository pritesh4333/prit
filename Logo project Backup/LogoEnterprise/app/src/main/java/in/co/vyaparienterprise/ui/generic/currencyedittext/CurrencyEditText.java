package in.co.vyaparienterprise.ui.generic.currencyedittext;
...
public class CurrencyEditText extends AppCompatEditText {
    ...
    private Locale defaultLocale = DateUtil.getIndiaLocale();
    ...
    public void setValue(double value) {
        ...
        String[] parts = _value.split(Pattern.quote("."));
        if (parts[1].length() == 1) {
            _value = _value + "0";
        }
        String formattedText = format(_value);
        setText(formattedText);
    }
    ...
    private void init() {
        ...
        currentLocale = DateUtil.getIndiaLocale();
