...
public class SalesReturnDetailActivity extends SohoActivity {
...
//        warehouseTV.setText(invoice.getWarehouse().getValue());
    ...
    public void editInvoice() {
        if (!isApproved) {
            ...
            String message = getString(R.string.edit_sale_return_change_status_msg);
            Utils.generateDialog(mContext, getString(R.string.edit_Sales_return), message,
    ...
    private void openEditInvoice() {
        ...
        startActivity(new Intent(mContext, CreateSalesReturnActivity.class));
        finish();
    }

//    private void changeStatusCall(final boolean goToEdit) {
//        InvoiceService.changeStatus(invoice.getId(), 4, StatusType, new ServiceCall<BaseModel<Boolean>>() {
//            @Override
//            public void start() {
