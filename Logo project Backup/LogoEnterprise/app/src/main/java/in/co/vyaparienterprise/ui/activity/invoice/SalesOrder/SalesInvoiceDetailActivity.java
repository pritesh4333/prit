...
public class SalesInvoiceDetailActivity extends SohoActivity {
...
//        warehouseTV.setText(invoice.getWarehouse().getValue());
    ...
    public void editInvoice() {
        if (!isApproved) {
            ...
            String message = getString(R.string.edit_sale_invoice_change_status_msg);
            Utils.generateDialog(mContext, getString(R.string.edit_Sales_invoice), message,
    ...
    private void openEditInvoice() {
        ...
        startActivity(new Intent(mContext, CreateSalesInvoiceActivity.class));
        finish();
    }
