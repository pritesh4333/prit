...
public class SalesDispatchDetailActivity extends SohoActivity {
...
//        }
    ...
    private void setInvoiceLineArea() {
        ...
        Total_amount.setText(getResources().getString(R.string.DispatchAmount));
...
//        warehouseTV.setText(invoice.getWarehouse().getValue());
    ...
    public void editInvoice() {
        if (!isApproved) {
            ...
            String message = getString(R.string.edit_sale_dispatch_change_status_msg);
            Utils.generateDialog(mContext, getString(R.string.edit_Sales_dispatch), message,
    ...
    private void openEditInvoice() {
        ...
        startActivity(new Intent(mContext, CreateSalesDispatchActivity.class));
        finish();
    }

//    private void changeStatusCall(final boolean goToEdit) {
//        InvoiceService.changeStatus(invoice.getId(), invoice.getInvoiceType(), StatusType, new ServiceCall<BaseModel<Boolean>>() {
//            @Override
//            public void start() {
