...
public class PurchaseInvoiceDetailActivity extends SohoActivity {
...
//        warehouseTV.setText(invoice.getWarehouse().getValue());
    ...
    public void editInvoice() {
        if (!isApproved) {
            ...
            String message = getString(R.string.edit_purchase_invoice_change_status_msg);
            Utils.generateDialog(mContext, getString(R.string.edit_Purchase_invoice), message,
    ...
    private void openEditInvoice() {
        ...
        startActivity(new Intent(mContext, CreatePurchaseInvoiceActivity.class));
        finish();
    }
