package in.co.vyaparienterprise.ui.activity.PaymentCollection;
...
public class CreateCollectionActivity extends SohoActivity implements View.OnClickListener, DatePickerDialog.OnDateSetListener {
    ...
    public void saveButtonClick() {
        ...
        if (save) {
            ...
            transaction.setAmount(formatestringtoDouble(Double.parseDouble(amt)));
    ...
    private void setFirmArea() {
        if (Create.equalsIgnoreCase("false")) {
            ...
            amount.setText(String.valueOf(format2DecAmountDouble(invoicedto.getTotalAmount())));
        ...
        ProductService.getCollectionType(new ServiceCall<BaseModel<List<CollectionTypeDTO>>>() {
            ...
            public void onResponse(boolean isOnline, BaseModel<List<CollectionTypeDTO>> response) {
                ...
                if (!response.isError()) {
                    ...
                    collection_type_spinner.setAdapter(new OneLineSpinnerAdapter(mContext, arapNo, Color.parseColor("#FFFFFF")));
...
//        }
    ...
    public static Double formatestringtoDouble(Double amount) {

        DecimalFormat df = new DecimalFormat("#.##");
        Double doubles = Double.valueOf(df.format(amount));
