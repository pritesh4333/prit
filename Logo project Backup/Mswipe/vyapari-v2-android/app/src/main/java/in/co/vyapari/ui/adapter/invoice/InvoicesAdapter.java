...
import static in.co.vyapari.ui.activity.invoice.CreateInvoiceActivity.paymentstatus;
...
public class InvoicesAdapter extends RecyclerSwipeAdapter<InvoicesAdapter.MyViewHolder> implements DownloadFile.Listener {
    ...
    private static ArrayList<InvoiceSum> invoiceSumList;
    private InvoiceDTO invoice;
    SwipeItemRecyclerMangerImpl mItemMange;
    private String type;
    private static int invoiceType;
    String text;
    public static String arapNo;
    static Spinner otherspinner;
    static InvoiceDTO invoiceDTO;
    private static String paymentType = null;
    private RemotePDFViewPager remotePDFViewPager;
    String destinationPath;
    public static int Selectedposition;
    static List<CollectionTypeDTO> collectioncode;
    static InvoicesAdapter.MyViewHolder adapterholder;
...
//        });
    ...
    private static void changeColor(int position, boolean isClick, MyViewHolder holder) {
    ...
    private static void getSaleDetailForPrint(String id, final int position, final MyViewHolder holder) {
    ...
    private void print(int position, MyViewHolder holder) {
        ...
        getSaleDetailForPrint(invoiceSumList.get(position).getId(), position, holder);
    }
    ...
    private void CollectionPayment(int position, MyViewHolder holder) {
        ...
        if (type.equalsIgnoreCase("Purchase")) {
            showPaymentOption(position, holder);
    ...
    private static void showPaymentOption(final int position, final MyViewHolder holder) {
        Selectedposition = position;
        adapterholder = holder;
        LayoutInflater inflater = (LayoutInflater) mContext.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        View dialogView = inflater.inflate(R.layout.collection_popup, null);
        ...
        amount.setText("" + invoiceSumList.get(position).getTotal());
        amount.clearFocus();
        if (paymentstatus.equalsIgnoreCase("Fail")) {
            ...
            approveokbutton.setVisibility(View.VISIBLE);
            //getSaleDetailForPrint(invoiceSumList.get(Selectedposition).getId(),Selectedposition,holder);
        } else {
            ...
            public void onClick(View view) {
                ...
                if(defaultAccount!=null) {
                    if (defaultAccount.getUsername().equalsIgnoreCase(login.getUserName()) && defaultAccount.getUsername() != null && defaultAccount.getBankid() != null) {
                        ...
                        Mswipe swipe = (Mswipe) Utils.getObjectSharedPreferencesValue(mContext, Constants.Mswipe_INFO, Mswipe.class);
                        if (swipe == null) {
                            Toasty.error(mContext, "Please save username and password in setting mswipe oprtion").show();
                        } else {
                            Intent intent_cardsale = new Intent(mContext, MswipeCardSaleActivity.class);
                            ...
                            intent_cardsale.putExtra("mobileno", swipe.getMobile());
                            intent_cardsale.putExtra("receiptno", invoiceSumList.get(position).getInvoiceNumber());
                            intent_cardsale.putExtra("notes", invoiceSumList.get(position).getDescription());
                            ...
                            ((Activity) mContext).startActivityForResult(intent_cardsale, MSWIPE_CARDSALE_ACTIVITY_REQUEST_CODE);
                        }
    ...
    private static void setCollectionType() {
        Utils.showLoading(mContext);
    ...
    private static void getSlipno(final int position, final MyViewHolder holder) {
    ...
    private static void CreateArAp(int position, MyViewHolder holder) {
        ...
        if (invoiceSumList.get(position).getDescription().equalsIgnoreCase("")) {
            arap.setDescription("");
        } else {
            arap.setDescription(invoiceSumList.get(position).getDescription());
        }
        ...
        if (invoiceDTO.getDescription().equalsIgnoreCase("")) {
            ...
            transaction.setDescription(invoiceSumList.get(position).getDescription());
        }


        transaction.setArpCode(invoiceDTO.getFirm().
    ...
    private static void saveCollectionARAP(int i, ArApCollection ArapCollection, final int position, final MyViewHolder holder) {
        Utils.showLoading(mContext);
...
//                    print.putExtra("Invoice", new Gson().toJson(invoiceDTO));
//                    mContext.startActivity(print);
                } else {
                    Toasty.error(mContext, response.getErrorDescription()).show();
                }
            }
    ...
    public static void Updateui() {
        showPaymentOption(Selectedposition, adapterholder);
        //getSaleDetailForPrint(invoiceSumList.get(Selectedposition).getId(),Selectedposition,adapterholder);
    }
